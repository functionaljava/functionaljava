...
The latest stable version is `4.8.2`.  This can be added to your Gradle project by adding the dependencies:
----
compile "org.functionaljava:functionaljava:4.8.2"
compile "org.functionaljava:functionaljava-java8:4.8.2"
compile "org.functionaljava:functionaljava-quickcheck:4.8.2"
compile "org.functionaljava:functionaljava-java-core:4.8.2"
----
