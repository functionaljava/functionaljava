...
public final class Longs {
	 ...
	 */
	public static final F<Long, F<Long, Long>> add = longAdditionSemigroup
			.sum();

	/**
	 * Curried Long multiplication.
	 */
	public static final F<Long, F<Long, Long>> multiply = longMultiplicationSemigroup
			.sum();
	 ...
	 * Remainder.
	 */
	public static final F<Long, F<Long, Long>> remainder = curry((a, b) -> a
			% b);
}
