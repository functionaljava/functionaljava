...
public final class Doubles {
	 ...
	 */
	public static final F<Double, F<Double, Double>> add = doubleAdditionSemigroup
			.sum();

	/**
	 * Curried Double multiplication.
	 */
	public static final F<Double, F<Double, Double>> multiply = doubleMultiplicationSemigroup
			.sum();

	/**
	 * Curried Double subtraction.
	 */
	public static final F<Double, F<Double, Double>> subtract = curry((x, y) -> x
			- y);
	 ...
	 * Remainder.
	 */
	public static final F<Double, F<Double, Double>> remainder = curry((a, b) -> a
			% b);
	 ...
	 * 
	 * @param doubles
	 *            A list of doubles to multiply together.
	...
	/**
	 * A function that returns true if the given double is greater than or equal
	 * to zero.
	 */
	...
	/**
	 * A function that returns true if the given double is less than or equal to
	 * zero.
	 */
