...
public final class Integers {
	 ...
	 */
	public static final F<Integer, F<Integer, Integer>> add = intAdditionSemigroup
			.sum();

	/**
	 * Curried Integer multiplication.
	 */
	public static final F<Integer, F<Integer, Integer>> multiply = intMultiplicationSemigroup
			.sum();

	/**
	 * Curried Integer subtraction.
	 */
	public static final F<Integer, F<Integer, Integer>> subtract = curry((x, y) -> x
			- y);
	 ...
	 * Remainder.
	 */
	public static final F<Integer, F<Integer, Integer>> remainder = curry((a, b) -> a
			% b);

	/**
	 * Power.
	 */
	public static final F<Integer, F<Integer, Integer>> power = curry((a, b) -> (int) StrictMath
			.pow(a, b));
	/**
	 * Evenness.
	 */
	...
	/**
	 * A function that returns true if the given integer is greater than or
	 * equal to zero.
	 */
	...
	/**
	 * A function that returns true if the given integer is less than or equal
	 * to zero.
	 */
