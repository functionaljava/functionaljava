...
public final class BigIntegers {
	 ...
	 */
	public static final F<BigInteger, F<BigInteger, BigInteger>> add = curry((
			a1, a2) -> a1.add(a2));

	/**
	 * Curried Integer multiplication.
	 */
	public static final F<BigInteger, F<BigInteger, BigInteger>> multiply = curry((a1,a2) -> a1.multiply(a2));

	/**
	 * Curried Integer subtraction.
	 */
	public static final F<BigInteger, F<BigInteger, BigInteger>> subtract = curry((a1, a2) -> a1.subtract(a2));
	 ...
	 * Remainder.
	 */
	public static final F<BigInteger, F<BigInteger, BigInteger>> remainder = curry((a1,a2) -> a1.remainder(a2));
