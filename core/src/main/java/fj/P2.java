...
public abstract class P2<A, B> {
	 ...
	 * 
	 * @param f
	 *            A function that will map the first element of this product.
	 * @param g
	...
	/**
	 * Duplicates this product on the first element, and maps the given function
	 * across the duplicate (Comonad pattern).
	 * 
	 * @param k
	 ...
	 * 
	 * @param c
	 *            The value with which to replace the first element of this
	 *            product.
	...
	/**
	 * Applies a list of comonadic functions to this product, returning a list
	 * of values.
	 * 
	 * @param fs
	 *            A list of functions to apply to this product.
	 * @return A list of the results of applying the given list of functions to
	 *         this product.
	 */
	...
	/**
	 * Applies a stream of comonadic functions to this product, returning a
	 * stream of values.
	 * 
	 * @param fs
	...
	public final <C> Stream<C> sequenceW(final Stream<F<P2<A, B>, C>> fs) {
		return fs.isEmpty() ? Stream.<C> nil() : Stream.cons(fs.head().f(this),
				new P1<Stream<C>>() {
					public Stream<C> _1() {
	 ...
	 * 
	 * @return A P2 that calls this P2 once for any given element and remembers
	 ...
	 * 
	 * @param f
	 *            A function that will map the first element of the given
	 *            product.
	 * @param g
	 *            A function that will map the second element of the given
	 *            product.
	 * @return A function that splits a given product between the two given
	 *         functions and combines their output.
	 */
	public static <A, B, C, D> F<P2<A, B>, P2<C, D>> split_(final F<A, C> f,
			final F<B, D> g) {
	 ...
	 * @return The given function, promoted to map the first element of
	 *         products.
	 */
	 ...
	 * @param f
	 *            The function to promote.
	 * @return The given function, promoted to map the second element of
	 *         products.
	 */
	...
	/**
	 * Sends the given input value to both argument functions and combines their
	 * output.
	 * 
	 * @param f
	 ...
	 */
	public static <B, C, D> P2<C, D> fanout(final F<B, C> f, final F<B, D> g,
			final B b) {
	 ...
	 * 
	 * @param f
	 *            A function to map over a product.
	 * @param p
	 ...
	 * 
	 * @param f
	 *            a curried function of arity-2 to transform into a function of
	 *            a product-2
	 ...
	 * 
	 * @param f
	 *            an uncurried function of arity-2 to transform into a function
	 *            of a product-2
	 * @return The function, transformed to operate on on a product-2
	 */
	 ...
	 * 
	 * @param f
	 *            A function of a product-2 to transform into an uncurried
	 *            function.
