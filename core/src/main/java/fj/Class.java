...
public final class Class<T> {
	...
	public List<Class<? super T>> inheritance() {
		return unfold(
				...
				new F<java.lang.Class<? super T>, Option<P2<java.lang.Class<? super T>, java.lang.Class<? super T>>>>() {
					public Option<P2<java.lang.Class<? super T>, java.lang.Class<? super T>>> apply(
				...
				new F<java.lang.Class<? super T>, Class<? super T>>() {
					public Class<? super T> apply(
							final java.lang.Class<? super T> c) {
						return clas(c);
					}
				});
	...
	/**
	 * Provides this class's type parameter information as a Tree of the type
	 * expression. Only descends into Parameterized classes. Non-abstract
	 * classes, or classes that don't implement an interface, are treated as raw
	 * types. Arrays, Type Variables, and Wildcards are treated as opaque Types.
	 * 
	...
	/**
	 * Provides this class's superclass type parameter information as a Tree of
	 * the type expression. Only descends into Parameterized classes.
	 * Non-abstract classes, or classes that don't implement an interface, are
	 * treated as raw types. Arrays, Type Variables, and Wildcards are treated
	 * as opaque Types.
	 * 
	 * @return The Tree representing the type expression for this class's
	 *         superclass.
	 */
	...
	/**
	 * Provides this class's interface type parameter information as a list of
	 * trees.
	 * 
	 * @return A list of trees representing the type expressions for this
	 *         class's interfaces.
	 */
	 ...
	 * Only descends into Parameterized classes. Non-abstract classes, or
	 * classes that don't implement an interface, are treated as raw types.
	 * Arrays, Type Variables, and Wildcards are treated as opaque Types.
	 * 
	 * @param t
	 *            The type (class) for which to get the generic type
	 *            information.
