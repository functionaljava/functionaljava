...
public final class Bottom {
	...
	/**
	 * Returns an error to represent undefinedness in a computation with early
	 * failure using the given message.
	 * 
	 * @param s
	 *            The message to fail with.
	 * @return An error to represent undefinedness in a computation with early
	 *         failure using the given message.
	 */
	...
	/**
	 * Provides a thunk that throws an error using the given message when
	 * evaluated.
	 * 
	 * @param s
	 *            The message to fail with.
	 * @return A thunk that throws an error using the given message when
	 *         evaluated.
	 */
	...
	/**
	 * Provides a function that throws an error using the given message,
	 * ignoring its argument.
	 * 
	 * @param s
	 *            The message to fail with.
	 * @return A function that throws an error using the given message, ignoring
	 *         its argument.
	 */
	...
	public static <A> Error decons(final A a, final Show<A> sa) {
		return error("Deconstruction failure on type " + a.getClass()
				+ " with value " + sa.show(a).toString());
	}
	 ...
	 * 
	 * @return A function that returns the <code>toString</code> for a
	 *         throwable.
	 */
	 ...
	 * 
	 * @return A function that returns the <code>getMessage</code> for a
	 *         throwable.
	 */
