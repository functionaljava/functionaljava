...
public final class P1Functions {
    ...
    public static <A> P1<Array<A>> sequence(final Array<P1<A>> as) {
        return new P1<Array<A>>() {
            public Array<A> _1() {
                return as.map(P1Functions.<A>__1());
            }
        };
    }
    ...
    /**
       ...
       */
      public static <A, X> P1<X> map(final P1<A> a, final F<A, X> f) {
        return new P1<X>() {
          public X _1() {
            return f.f(a._1());
          }
    ...
    /**
       ...
       */
      public static <A> P1<A> memo(final P1<A> self) {
        return new P1<A>() {
    ...
    /**
       ...
       */
      public static <A, B> F<B, A> constant(final P1<A> a) {
        return new F<B, A>() {
