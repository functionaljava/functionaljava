...
public final class Hash<A> {
	 ...
	 */
	public static final Hash<StringBuffer> stringBufferHash = new Hash<>(
			sb -> {
				final int p = 419;
				int r = 239;
	 ...
	 * 
	 * @param ha
	 *            Hash the left side of <code>Either</code>.
	 * @param hb
	 *            Hash the right side of <code>Either</code>.
	 * @return A hash instance for the {@link Either} type.
	 */
	public static <A, B> Hash<Either<A, B>> eitherHash(final Hash<A> ha,
			final Hash<B> hb) {
		return new Hash<Either<A, B>>(e -> e.isLeft() ? ha.hash(e.left()
				.value()) : hb.hash(e.right().value()));
	}
	 ...
	 * 
	 * @param ha
	 *            Hash the failing side of <code>Validation</code>.
	 * @param hb
	 *            Hash the succeeding side of <code>Validation</code>.
	 * @return A hash instance for the {@link Validation} type.
	 */
	public static <A, B> Hash<Validation<A, B>> validationHash(
			final Hash<A> ha, final Hash<B> hb) {
	 ...
	 */
	public static <A, B> Hash<P2<A, B>> p2Hash(final Hash<A> ha,
			final Hash<B> hb) {
	 ...
	 */
	public static <A, B, C> Hash<P3<A, B, C>> p3Hash(final Hash<A> ha,
			final Hash<B> hb, final Hash<C> hc) {
	 ...
	 */
	public static <A, B, C, D> Hash<P4<A, B, C, D>> p4Hash(final Hash<A> ha,
			final Hash<B> hb, final Hash<C> hc, final Hash<D> hd) {
	 ...
	 */
	public static <A, B, C, D, E> Hash<P5<A, B, C, D, E>> p5Hash(
			final Hash<A> ha, final Hash<B> hb, final Hash<C> hc,
	 ...
	 */
	public static <A, B, C, D, E, F$> Hash<P6<A, B, C, D, E, F$>> p6Hash(
			final Hash<A> ha, final Hash<B> hb, final Hash<C> hc,
			final Hash<D> hd, final Hash<E> he, final Hash<F$> hf) {
	 ...
	 */
	public static <A, B, C, D, E, F$, G> Hash<P7<A, B, C, D, E, F$, G>> p7Hash(
			final Hash<A> ha, final Hash<B> hb, final Hash<C> hc,
			final Hash<D> hd, final Hash<E> he, final Hash<F$> hf,
			final Hash<G> hg) {
	 ...
	 */
	public static <A, B, C, D, E, F$, G, H> Hash<P8<A, B, C, D, E, F$, G, H>> p8Hash(
			final Hash<A> ha, final Hash<B> hb, final Hash<C> hc,
			final Hash<D> hd, final Hash<E> he, final Hash<F$> hf,
