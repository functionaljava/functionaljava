...
public final class Function {
	 ...
	 * @return A function that is the composition of the given arguments.
	 */
	public static <A, B, C, D> F<A, F<B, D>> compose2(final F<C, D> f,
			final F<A, F<B, C>> g) {
	...
	/**
	 * Returns a function that given an argument, returns a function that
	 * ignores its argument.
	 * 
	 * @return A function that given an argument, returns a function that
	 *         ignores its argument.
	 */
	...
	/**
	 * Returns a function that ignores its argument to constantly produce the
	 * given value.
	 * 
	 * @param b
	 *            The value to return when the returned function is applied.
	 * @return A function that ignores its argument to constantly produce the
	 *         given value.
	 */
	 ...
	 * <code>null</code> value and if so, does not apply the value, instead
	 * returning an empty optional value.
	 * 
	 * @param f
	 *            The function to check for a <code>null</code> argument.
	 * @return A function that inspects the argument of the given function for a
	 *         <code>null</code> value and if so, does not apply the value,
	 *         instead returning an empty optional value.
	 */
	 ...
	 * @return A curried form of the given function.
	 */
	public static <A, B, C, D> F<B, F<C, D>> curry(final F3<A, B, C, D> f,
			final A a) {
		return curry(f).f(a);
	}
	 ...
	 * @return A curried form of the given function.
	 */
	public static <A, B, C, D> F<C, D> curry(final F3<A, B, C, D> f, final A a,
			final B b) {
	 ...
	 * @return An uncurried function.
	 */
	public static <A, B, C, D> F3<A, B, C, D> uncurryF3(
	 ...
	 * @return A curried form of the given function.
	 */
	public static <A, B, C, D, E> F<A, F<B, F<C, F<D, E>>>> curry(
			final F4<A, B, C, D, E> f) {
	 ...
	 * @return A curried form of the given function.
	 */
	public static <A, B, C, D, E> F<B, F<C, F<D, E>>> curry(
			final F4<A, B, C, D, E> f, final A a) {
		return curry(f).f(a);
	}
	 ...
	 * @return A curried form of the given function.
	 */
	public static <A, B, C, D, E> F<C, F<D, E>> curry(
			final F4<A, B, C, D, E> f, final A a, final B b) {
	 ...
	 * @return A curried form of the given function.
	 */
	public static <A, B, C, D, E> F<D, E> curry(final F4<A, B, C, D, E> f,
	 ...
	 * @return An uncurried function.
	 */
	public static <A, B, C, D, E> F4<A, B, C, D, E> uncurryF4(
	 ...
	 * @return A curried form of the given function.
	 */
	public static <A, B, C, D, E, F$> F<A, F<B, F<C, F<D, F<E, F$>>>>> curry(
			final F5<A, B, C, D, E, F$> f) {
	 ...
	 * @return A curried form of the given function.
	 */
	public static <A, B, C, D, E, F$> F<B, F<C, F<D, F<E, F$>>>> curry(
			final F5<A, B, C, D, E, F$> f, final A a) {
		return curry(f).f(a);
	}
	 ...
	 * @return A curried form of the given function.
	 */
	public static <A, B, C, D, E, F$> F<C, F<D, F<E, F$>>> curry(
			final F5<A, B, C, D, E, F$> f, final A a, final B b) {
		return curry(f).f(a).f(b);
	}
	 ...
	 * @return A curried form of the given function.
	 */
	public static <A, B, C, D, E, F$> F<D, F<E, F$>> curry(
			final F5<A, B, C, D, E, F$> f, final A a, final B b, final C c) {
		return curry(f).f(a).f(b).f(c);
	}
	 ...
	 * @return A curried form of the given function.
	 */
	public static <A, B, C, D, E, F$> F<E, F$> curry(
			final F5<A, B, C, D, E, F$> f, final A a, final B b, final C c,
			final D d) {
	 ...
	 * @return An uncurried function.
	 */
	public static <A, B, C, D, E, F$> F5<A, B, C, D, E, F$> uncurryF5(
	 ...
	 * @return A curried form of the given function.
	 */
	public static <A, B, C, D, E, F$, G> F<A, F<B, F<C, F<D, F<E, F<F$, G>>>>>> curry(
			final F6<A, B, C, D, E, F$, G> f) {
	 ...
	 * @return A curried form of the given function.
	 */
	public static <A, B, C, D, E, F$, G, H> F<C, F<D, F<E, F<F$, F<G, H>>>>> curry(
			final F7<A, B, C, D, E, F$, G, H> f, final A a, final B b) {
		return curry(f).f(a).f(b);
	}
	 ...
	 * @return A curried form of the given function.
	 */
	public static <A, B, C, D, E, F$, G, H> F<D, F<E, F<F$, F<G, H>>>> curry(
			final F7<A, B, C, D, E, F$, G, H> f, final A a, final B b, final C c) {
		return curry(f).f(a).f(b).f(c);
	}
	 ...
	 * @return A curried form of the given function.
	 */
	public static <A, B, C, D, E, F$, G, H> F<E, F<F$, F<G, H>>> curry(
			final F7<A, B, C, D, E, F$, G, H> f, final A a, final B b,
			final C c, final D d) {
		return curry(f).f(a).f(b).f(c).f(d);
	}
	 ...
	 * @return A curried form of the given function.
	 */
	public static <A, B, C, D, E, F$, G, H> F<F$, F<G, H>> curry(
			final F7<A, B, C, D, E, F$, G, H> f, final A a, final B b,
	 ...
	 * @return A curried form of the given function.
	 */
	public static <A, B, C, D, E, F$, G, H> F<G, H> curry(
			final F7<A, B, C, D, E, F$, G, H> f, final A a, final B b,
	...
	public static <A, B, C, D, E, F$, G, H, I> F<A, F<B, F<C, F<D, F<E, F<F$, F<G, F<H, I>>>>>>>> curry(
		...
		return a -> b -> c -> d -> e -> f$ -> g -> h -> f.f(a, b, c, d, e, f$,
				g, h);
	}
	 ...
	 * @return A curried form of the given function.
	 */
	public static <A, B, C, D, E, F$, G, H, I> F<E, F<F$, F<G, F<H, I>>>> curry(
			final F8<A, B, C, D, E, F$, G, H, I> f, final A a, final B b,
			final C c, final D d) {
		return curry(f).f(a).f(b).f(c).f(d);
	}
	 ...
	 * @return A curried form of the given function.
	 */
	public static <A, B, C, D, E, F$, G, H, I> F<F$, F<G, F<H, I>>> curry(
			final F8<A, B, C, D, E, F$, G, H, I> f, final A a, final B b,
			final C c, final D d, final E e) {
		return curry(f).f(a).f(b).f(c).f(d).f(e);
	}
	 ...
	 * @return A curried form of the given function.
	 */
	public static <A, B, C, D, E, F$, G, H, I> F<G, F<H, I>> curry(
			final F8<A, B, C, D, E, F$, G, H, I> f, final A a, final B b,
			final C c, final D d, final E e, final F$ f$) {
		return curry(f).f(a).f(b).f(c).f(d).f(e).f(f$);
	}
	 ...
	 * @return A curried form of the given function.
	 */
	public static <A, B, C, D, E, F$, G, H, I> F<H, I> curry(
			final F8<A, B, C, D, E, F$, G, H, I> f, final A a, final B b,
	...
	public static <A, B, C, D, E, F$, G, H, I> F8<A, B, C, D, E, F$, G, H, I> uncurryF8(
		...
		return (a, b, c, d, e, f$, g, h) -> f.f(a).f(b).f(c).f(d).f(e).f(f$)
				.f(g).f(h);
	}

	/**
	 * Binds the function in the second argument to the function in the first
	 * argument.
	 * 
	 * @param ma
	 *            A function whose argument type is the same as the argument
	 *            type of the return value.
	 * @param f
	 *            A function whose argument type is the same as the return type
	 *            of <em>ma</em>, and yields the return value.
	 * @return A function that chains the given functions together such that the
	 *         result of applying <em>ma</em> to the argument is given to
	 *         <i>f</i>, yielding a function that is applied to the argument
	 *         again.
	 */
	 ...
	 *         the given function.
	 */
	public static <A, B, C> F<C, B> apply(final F<C, F<A, B>> cab,
			final F<C, A> ca) {
		return bind(cab, f -> compose(f::f, ca));

	}

	/**
	 * Binds the given function <em>f</em> to the values of the given functions,
	 * with a final join.
	 * 
	 * @param ca
	 *            A function to bind <em>f</em> function to.
	 * @param cb
	 *            A function to bind <em>f</em> function to.
	 * @param f
	 *            The bound function to be composed with <em>ca</em> and then
	 *            applied with <em>cb</em>
	 * @return A new function after performing the composition, then
	 *         application.
	 */
	public static <A, B, C, D> F<D, C> bind(final F<D, A> ca, final F<D, B> cb,
			final F<A, F<B, C>> f) {
		return apply(compose(f, ca), cb);
	}

	/**
	 * Applies a given function over the arguments of another function of
	 * arity-2.
	 * 
	 * @param a
	 *            The function whose arguments to apply another function over.
	 * @param f
	 *            The function to apply over the arguments of another function.
	 * @return A function whose arguments are fed through function f, before
	 *         being passed to function a.
	 */
	public static <A, B, C> F<B, F<B, C>> on(final F<A, F<A, C>> a,
			final F<B, A> f) {
	 ...
	 */
	public static <A, B, C, D> F<F<D, A>, F<F<D, B>, F<D, C>>> lift(
			final F<A, F<B, C>> f) {
		return curry((ca, cb) -> bind(ca, cb, f));
	}

	/**
	 * Joins two arguments of a function of arity-2 into one argument, yielding
	 * a function of arity-1.
	 * 
	 * @param f
	 *            A function whose arguments to join.
	 * @return A function of arity-1 whose argument is substituted for both
	 *         parameters of <em>f</em>.
	 */
	...
	/**
	 * Partial application of the second argument to the supplied function to
	 * get a function of type <tt>A -> C</tt>. Same as <tt>flip(f).f(b)</tt>.
	 * 
	 * @param f
	 *            The function to partially apply.
	 * @param b
	 *            The value to apply to the function.
	 * @return A new function based on <tt>f</tt> with its second argument
	 *         applied.
	 */
	public static <A, B, C> F<A, C> partialApply2(final F<A, F<B, C>> f,
			final B b) {
		return a -> uncurryF2(f).f(a, b);
	}

	/**
	 * Partial application of the third argument to the supplied function to get
	 * a function of type <tt>A -> B -> D</tt>.
	 * 
	 * @param f
	 *            The function to partially apply.
	 * @param c
	 *            The value to apply to the function.
	 * @return A new function based on <tt>f</tt> with its third argument
	 *         applied.
	 */
	public static <A, B, C, D> F<A, F<B, D>> partialApply3(
			final F<A, F<B, F<C, D>>> f, final C c) {
		return a -> b -> uncurryF3(f).f(a, b, c);
	}

	/**
	 * Partial application of the fourth argument to the supplied function to
	 * get a function of type <tt>A -> B -> C -> E</tt>.
	 * 
	 * @param f
	 *            The function to partially apply.
	 * @param d
	 *            The value to apply to the function.
	 * @return A new function based on <tt>f</tt> with its fourth argument
	 *         applied.
	 */
	public static <A, B, C, D, E> F<A, F<B, F<C, E>>> partialApply4(
			final F<A, F<B, F<C, F<D, E>>>> f, final D d) {
		return a -> b -> c -> uncurryF4(f).f(a, b, c, d);
	}

	/**
	 * Partial application of the fifth argument to the supplied function to get
	 * a function of type <tt>A -> B -> C -> D -> F$</tt>.
	 * 
	 * @param f
	 *            The function to partially apply.
	 * @param e
	 *            The value to apply to the function.
	 * @return A new function based on <tt>f</tt> with its fifth argument
	 *         applied.
	 */
	public static <A, B, C, D, E, F$> F<A, F<B, F<C, F<D, F$>>>> partialApply5(
			final F<A, F<B, F<C, F<D, F<E, F$>>>>> f, final E e) {
		return a -> b -> c -> d -> uncurryF5(f).f(a, b, c, d, e);
	}

	/**
	 * Partial application of the sixth argument to the supplied function to get
	 * a function of type <tt>A -> B -> C -> D -> E -> G</tt>.
	 * 
	 * @param f
	 *            The function to partially apply.
	 * @param f$
	 *            The value to apply to the function.
	 * @return A new function based on <tt>f</tt> with its sixth argument
	 *         applied.
	 */
	...
	/**
	 * Partial application of the seventh argument to the supplied function to
	 * get a function of type <tt>A -> B -> C -> D -> E -> F$ -> H</tt>.
	 * 
	 * @param f
	 *            The function to partially apply.
	 * @param g
	 *            The value to apply to the function.
	 * @return A new function based on <tt>f</tt> with its seventh argument
	 *         applied.
	 */
	public static <A, B, C, D, E, F$, G, H> F<A, F<B, F<C, F<D, F<E, F<F$, H>>>>>> partialApply7(
			final F<A, F<B, F<C, F<D, F<E, F<F$, F<G, H>>>>>>> f, final G g) {
		return a -> b -> c -> d -> e -> f$ -> uncurryF7(f).f(a, b, c, d, e, f$,
				g);
	}

	/**
	 * Partial application of the eigth argument to the supplied function to get
	 * a function of type <tt>A -> B -> C -> D -> E -> F$ -> G -> I</tt>.
	 * 
	 * @param f
	 *            The function to partially apply.
	 * @param h
	 *            The value to apply to the function.
	 * @return A new function based on <tt>f</tt> with its eigth argument
	 *         applied.
	 */
	public static <A, B, C, D, E, F$, G, H, I> F<A, F<B, F<C, F<D, F<E, F<F$, F<G, I>>>>>>> partialApply8(
			final F<A, F<B, F<C, F<D, F<E, F<F$, F<G, F<H, I>>>>>>>> f,
			final H h) {
		return a -> b -> c -> d -> e -> f$ -> g -> uncurryF8(f).f(a, b, c, d,
				e, f$, g, h);
	}
}
