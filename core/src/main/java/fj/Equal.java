...
public final class Equal<A> {
	 ...
	 * 
	 * @param f
	 *            The function to construct the equal with.
	 ...
	 * 
	 * @param ea
	 *            Equality across the left side of {@link Either}.
	 * @param eb
	 *            Equality across the right side of {@link Either}.
	 * @return An equal instance for the {@link Either} type.
	 */
	public static <A, B> Equal<Either<A, B>> eitherEqual(final Equal<A> ea,
			final Equal<B> eb) {
		return new Equal<Either<A, B>>(e1 -> e2 -> e1.isLeft() && e2.isLeft()
				&& ea.f.f(e1.left().value()).f(e2.left().value())
				|| e1.isRight() && e2.isRight()
				&& eb.f.f(e1.right().value()).f(e2.right().value()));
	 ...
	 * 
	 * @param ea
	 *            Equality across the failing side of {@link Validation}.
	 * @param eb
	 *            Equality across the succeeding side of {@link Validation}.
	 * @return An equal instance for the {@link Validation} type.
	 */
	public static <A, B> Equal<Validation<A, B>> validationEqual(
			final Equal<A> ea, final Equal<B> eb) {
	 ...
	 * 
	 * @param ea
	 *            Equality across the elements of the list.
	 ...
	 * 
	 * @param ea
	 *            Equality across the elements of the non-empty list.
	 ...
	 * 
	 * @param ea
	 *            Equality across the element of the option.
	 ...
	 * 
	 * @param ea
	 *            Equality across the elements of the array.
	 ...
	 * 
	 * @param ea
	 *            Equality across the elements of the tree.
	 * @return An equal instance for the {@link Tree} type.
	 */
	public static <A> Equal<Tree<A>> treeEqual(final Equal<A> ea) {
		return new Equal<Tree<A>>(curry((t1, t2) -> ea.eq(t1.root(), t2.root())
				&& p1Equal(streamEqual(treeEqual(ea))).eq(t2.subForest(),
						t1.subForest())));
	}
	 ...
	 *            Equality across the second element of the product.
	 * @param ec
	 *            Equality across the third element of the product.
	 ...
	 *            Equality across the third element of the product.
	 * @param ed
	 *            Equality across the fourth element of the product.
	 ...
	 *            Equality across the fourth element of the product.
	 * @param ee
	 *            Equality across the fifth element of the product.
	 ...
	 *            Equality across the fifth element of the product.
	 * @param ef
	 *            Equality across the sixth element of the product.
	 ...
	 *            Equality across the sixth element of the product.
	 * @param eg
	 *            Equality across the seventh element of the product.
	 ...
	 *            Equality across the seventh element of the product.
	 * @param eh
	 *            Equality across the eighth element of the product.
	 ...
	 * 
	 * @param ea
	 *            Equality across the elements of the vector.
	 ...
	 */
	public static final Equal<LazyString> eq = streamEqual(charEqual).comap(
			LazyString.toStream);
	 ...
	 * 
	 * @param e
	 *            Equality for the first element of the list.
	 * @param l
	 *            Equality for the rest of the list.
