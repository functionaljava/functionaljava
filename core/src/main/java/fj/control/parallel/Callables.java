...
public final class Callables {
	...
	/**
	 * Returns a callable that completely preserves the argument. The unit
	 * function for Callables.
	 * 
	 * @param a
	 *            A value to preserve in a Callable
	...
	/**
	 * Returns a callable that throws the given exception. The unit function for
	 * Callables.
	 * 
	 * @param e
	...
	/**
	 * Provides a transformation from a value to a Callable that completely
	 * preserves that value.
	 * 
	 * @return A function from a value to a Callable that completely preserves
	 *         that value.
	 */
	...
	/**
	 * Provides a transformation from a function to a Callable-valued function
	 * that is equivalent to it. The first-class Kleisli arrow for Callables.
	 * 
	 * @return A transformation from a function to the equivalent
	 ...
	 * 
	 * @param a
	 *            A value in a Callable to which to apply a function.
	 * @param f
	 *            A function to apply to the value in a Callable.
	 * @return The result of applying the function in the second argument to the
	 *         value of the Callable in the first.
	 */
	public static <A, B> Callable<B> bind(final Callable<A> a,
			final F<A, Callable<B>> f) {
	 ...
	 * 
	 * @param f
	 *            A function to lift to a function on Callables.
	...
	/**
	 * Performs function application within a callable (applicative functor
	 * pattern).
	 * 
	 * @param ca
	 ...
	 * @return A new callable after applying the given callable function to the
	 *         first argument.
	 */
	 ...
	 * 
	 * @param a
	 *            The Callable of a Callable to join.
	...
	public static <A> Callable<List<A>> sequence(final List<Callable<A>> as) {
		return as.foldRight(
				Callables.<A, List<A>, List<A>> liftM2(List.<A> cons()),
				callable(List.<A> nil()));
	}
	 ...
	 * 
	 * @return A function from a List of Callables to a single Callable of a
	 *         List.
	 */
	 ...
	 * 
	 * @param a
	 *            The callable to convert to an optional value.
	 * @return An optional value that yields the value in the Callable, or None
	...
	/**
	 * Turns the given Callable into either an exception or the value in the
	 * Callable.
	 * 
	 * @param a
	 *            The callable to convert to an Either value.
	 * @return Either the value in the given Callable, or the Exception with
	 *         which the Callable fails.
	 */
	 ...
	 * 
	 * @param e
	 *            Either an exception or a value to wrap in a Callable
	 ...
	 * 
	 * @param o
	 *            An optional value to turn into a Callable.
	 * @return A Callable that yields some value or throws an exception in the
	 *         case of no value.
	 */
	 ...
	 * 
	 * @return A function that turns an optional value into a Callable that
	...
	/**
	 * Normalises the given Callable by calling it and wrapping the result in a
	 * new Callable. If the given Callable throws an Exception, the resulting
	 * Callable will throw that same Exception.
	 * 
	 * @param a
	 *            The callable to evaluate.
	 * @return A normalised callable that just returns the result of calling the
	 *         given callable.
	 */
	 ...
	 * 
	 * @return A function that normalises the given Callable by calling it and
