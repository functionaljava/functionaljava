...
public final class Array<A> implements Iterable<A> {
	...
	/**
	 * Returns an iterator for this array. This method exists to permit the use
	...
	/**
	 * Returns <code>true</code> is this array is empty, <code>false</code>
	 * otherwise.
	 * 
	 * @return <code>true</code> is this array is empty, <code>false</code>
	 *         otherwise.
	 */
	...
	/**
	 * Returns <code>false</code> is this array is empty, <code>true</code>
	 * otherwise.
	 * 
	 * @return <code>false</code> is this array is empty, <code>true</code>
	 *         otherwise.
	 */
	...
	/**
	 * Returns an option projection of this array; <code>None</code> if empty,
	 ...
	 * 
	 * @param x
	 *            The value to return in left if this array is empty.
	 * @return An either projection of this array.
	 */
	@SuppressWarnings("unchecked")
	public <X> Either<X, A> toEither(final P1<X> x) {
		return a.length == 0 ? Either.<X, A> left(x._1()) : Either
				.<X, A> right((A) a[0]);
	}
	 ...
	 * 
	 * @param f
	 *            The function to map across this array.
	 * @return A new array after the given function has been applied to each
	 *         element.
	 */
	@SuppressWarnings({ "unchecked" })
	...
	/**
	 * Performs a right-fold reduction across this array. This function runs in
	 * constant stack space.
	 * 
	 * @param f
	 *            The function to apply on each element of the array.
	 * @param b
	...
	/**
	 * Performs a left-fold reduction across this array. This function runs in
	 * constant space.
	 * 
	 * @param f
	 *            The function to apply on each element of the array.
	...
	/**
	 * Binds the given function across each element of this array with a final
	 * join.
	 * 
	 * @param f
	...
	public <B> Array<B> bind(final F<A, Array<B>> f) {
		...
		x.foreach(new F<Array<B>, Unit>() {
			...
			public Unit apply(final Array<B> x) {
	...
	/**
	 * Performs a bind across each array element, but ignores the element value
	 * each time.
	 * 
	 * @param bs
	 *            The array to apply in the final join.
	...
	/**
	 * Binds the given function across each element of this array and the given
	 * array with a final join.
	 * 
	 * @param sb
	 *            A given array to bind the given function with.
	 * @param f
	 *            The function to apply to each element of this array and the
	 *            given array.
	 * @return A new array after performing the map, then final join.
	 */
	...
	/**
	 * Performs function application within an array (applicative functor
	 * pattern).
	 * 
	 * @param lf
	 *            The array of functions to apply.
	 * @return A new array after applying the given array of functions through
	 *         this array.
	 */
	public <B> Array<B> apply(final Array<F<A, B>> lf) {
		return lf.bind((F<A, B> f) -> map(f::f));
	}
	 ...
	 * 
	 * @param aas
	 *            The array to append to this one.
	 ...
	 * 
	 * @param a
	 *            The elements to construct the array with.
	...
	/**
	 * Unsafe package-private constructor. The elements of the given array must
	 * be assignable to the given type.
	 * 
	 * @param a
	...
	public static <A, B> F<F<A, B>, F<Array<A>, Array<B>>> map() {
		return curry((F<A, B> abf, Array<A> array) -> array.map(abf));
	}
	 ...
	 * of this array, <code>false</code> otherwise (<code>true</code> for the
	 * empty array).
	 * 
	 * @param f
	 *            the predicate function to test on each element of this array.
	 * @return <code>true</code> if the predicate holds for all of the elements
	 *         of this array, <code>false</code> otherwise.
	 */
	@SuppressWarnings("unchecked")
	 ...
	 * elements of this array, <code>false</code> otherwise (<code>false</code>
	 * for the empty array).
	 * 
	 * @param f
	 ...
	 * 
	 * @param f
	 *            The predicate function to test on elements of this array.
	...
	/**
	 * Returns an array of integers from the given <code>from</code> value
	 * (inclusive) to the given <code>to</code> value (exclusive).
	 * 
	 * @param from
	 *            The minimum value for the array (inclusive).
	 * @param to
	 *            The maximum value for the array (exclusive).
	 * @return An array of integers from the given <code>from</code> value
	 *         (inclusive) to the given <code>to</code> value (exclusive).
	 */
	...
	/**
	 * Zips this array with the given array using the given function to produce
	 * a new array. If this array and the given array have different lengths,
	 * then the longer array is normalised so this function never fails.
	 * 
	 * @param bs
	 *            The array to zip this array with.
	 * @param f
	 *            The function to zip this array and the given array with.
	 * @return A new array with a length the same as the shortest of this array
	 *         and the given array.
	 */
	...
	/**
	 * Zips this array with the given array to produce an array of pairs. If
	 * this array and the given array have different lengths, then the longer
	 * array is normalised so this function never fails.
	 * 
	 * @param bs
	 *            The array to zip this array with.
	 * @return A new array with a length the same as the shortest of this array
	...
	public Array<P2<A, Integer>> zipIndex() {
		return zipWith(range(0, length()), (A a) -> (Integer i) -> p(a, i));
	}
	 ...
	 * 
	 * @param i
	 *            The iterable to take to an array.
	 ...
	 * 
	 * @param xs
	 *            The array of pairs to transform.
	...
	public final class ImmutableProjection<A> implements Iterable<A> {
		...
		/**
		 * Returns an iterator for this array. This method exists to permit the
		...
		/**
		 * Returns an option projection of this array; <code>None</code> if
		 * empty, or the first element in <code>Some</code>.
		 * 
		 * @return An option projection of this array.
		 */
		public Option<A> toOption() {
		...
		/**
		 * Returns an either projection of this array; the given argument in
		 * <code>Left</code> if empty, or the first element in
		 * <code>Right</code>.
		 * 
		 * @param x
		 *            The value to return in left if this array is empty.
		...
		/**
		 * Filters elements from this array by returning only elements which
		...
		/**
		 * Performs a right-fold reduction across this array. This function uses
		...
		/**
		 * Performs a left-fold reduction across this array. This function runs
		 * in constant space.
		 * 
		 * @param f
		 *            The function to apply on each element of the array.
		...
		/**
		 * Binds the given function across each element of this array with a
		 * final join.
		 * 
		 * @param f
		 *            The function to apply to each element of this array.
		...
		/**
		 * Performs a bind across each array element, but ignores the element
		 * value each time.
		 * 
		 * @param bs
		 *            The array to apply in the final join.
		 ...
		 * @param lf
		 *            The array of functions to apply.
		 * @return A new array after applying the given array of functions
		 *         through this array.
		 */
		public <B> Array<B> apply(final Array<F<A, B>> lf) {
			return a.apply(lf);
	...
	@SuppressWarnings({ "SuspiciousSystemArraycopy", "unchecked",
			"ObjectEquality", "RedundantCast" })
	public static <T, U> T[] copyOf(final U[] a, final int len,
			final Class<? extends T[]> newType) {
		final T[] copy = (Object) newType == Object[].class ? (T[]) new Object[len]
				: (T[]) java.lang.reflect.Array.newInstance(
						newType.getComponentType(), len);
	...
	public static char[] copyOfRange(final char[] a, final int from,
			final int to) {
