...
/**
 * Isomorphic to {@link Either} but has renamed functions and represents failure
 * on the left and success on the right. This type also has accumulating
 * functions that accept a {@link Semigroup} for binding computation while
 * keeping error values
 * 
...
public final class Validation<E, T> implements Iterable<T> {
	...
	/**
	 * Returns <code>true</code> if this is a failure, <code>false</code>
	 * otherwise.
	 * 
	...
	/**
	 * Returns <code>true</code> if this is a success, <code>false</code>
	 * otherwise.
	 * 
	 * @return <code>true</code> if this is a success, <code>false</code>
	 *         otherwise.
	 */
	...
	/**
	 * Returns the failing value, or throws an error if there is no failing
	 * value.
	 * 
	 * @return the failing value, or throws an error if there is no failing
	 *         value.
	 */
	public E fail() {
		if (isFail())
	...
	/**
	 * Returns the success value, or throws an error if there is no success
	 * value.
	 * 
	 * @return the success value, or throws an error if there is no success
	 *         value.
	 */
	public T success() {
		if (isSuccess())
	...
	/**
	 * The catamorphism for validation. Folds over this validation breaking into
	 * left or right.
	 * 
	 * @param fail
	 *            The function to call if this failed.
	 * @param success
	...
	/**
	 * The success value or the application of the given function to the failing
	 * value.
	 * 
	 * @param f
	 *            The function to execute on the failing value.
	 * @return The success value or the application of the given function to the
	 *         failing value.
	 */
	...
	public <A> Validation<E, A> map(final F<T, A> f) {
		return isFail() ? Validation.<E, A> fail(fail()) : Validation
				.<E, A> success(f.f(success()));
	}

	/**
	 * Binds the given function across this validation's success value if it has
	 * one.
	 * 
	 * @param f
	 ...
	 *         <code>p</code> does not hold for the success value, otherwise,
	 *         returns a success in <code>Some</code>.
	 */
	...
	/**
	 * Returns <code>true</code> if this is a failure or returns the result of
	 * the application of the given function to the success value.
	 * 
	 * @param f
	 *            The predicate function to test on this success value.
	 * @return <code>true</code> if this is a failure or returns the result of
	 *         the application of the given function to the success value.
	 */
	...
	/**
	 * Returns <code>false</code> if this is a failure or returns the result of
	 * the application of the given function to the success value.
	 * 
	 * @param f
	 *            The predicate function to test on this success value.
	 * @return <code>false</code> if this is a failure or returns the result of
	 *         the application of the given function to the success value.
	 */
	...
	/**
	 * Returns a single element list if this is a success value, otherwise an
	 * empty list.
	 * 
	 * @return A single element list if this is a success value, otherwise an
	 *         empty list.
	 */
	...
	/**
	 * Returns the success value in <code>Some</code> if there is one, otherwise
	 * <code>None</code>.
	 * 
	 * @return The success value in <code>Some</code> if there is one, otherwise
	 *         <code>None</code>.
	 */
	...
	/**
	 * Returns a single element array if this is a success value, otherwise an
	 * empty list.
	 * 
	 * @return A single element array if this is a success value, otherwise an
	 *         empty list.
	 */
	...
	/**
	 * Returns a single element stream if this is a success value, otherwise an
	 * empty list.
	 * 
	 * @return A single element stream if this is a success value, otherwise an
	 *         empty list.
	 */
	...
	/**
	 * Function application on the successful side of this validation, or
	 * accumulating the errors on the failing side using the given semigroup
	 * should one or more be encountered.
	 * 
	 * @param s
	 *            The semigroup to accumulate errors with if
	 * @param v
	 *            The validating function to apply.
	 * @return A failing validation if this or the given validation failed (with
	 *         errors accumulated if both) or a succeeding validation if both
	 *         succeeded.
	 */
	@SuppressWarnings({ "unchecked" })
	public <A> Validation<E, A> accumapply(final Semigroup<E> s,
			final Validation<E, F<T, A>> v) {
		return isFail() ? Validation.<E, A> fail(v.isFail() ? s.sum(v.fail(),
				fail()) : fail()) : v.isFail() ? Validation.<E, A> fail(v
				.fail()) : Validation.<E, A> success(v.success().f(success()));
	}

	/**
	 * Accumulates errors on the failing side of this or any given validation if
	 * one or more are encountered, or applies the given function if all
	 * succeeded and returns that value on the successful side.
	 * 
	 * @param s
	 *            The semigroup to accumulate errors with if one or more
	 *            validations fail.
	 * @param va
	 *            The second validation to accumulate errors with if it failed.
	 * @param f
	 *            The function to apply if all validations have succeeded.
	 * @return A succeeding validation if all validations succeeded, or a
	 *         failing validation with errors accumulated if one or more failed.
	 */
	public <A, B> Validation<E, B> accumulate(final Semigroup<E> s,
			final Validation<E, A> va, final F<T, F<A, B>> f) {
	 ...
	 */
	public <A, B> Validation<E, B> accumulate(final Semigroup<E> s,
			final Validation<E, A> va, final F2<T, A, B> f) {
	 ...
	 * @param va
	 *            The second validation to accumulate errors with if it failed.
	 * @return A <code>Some</code> if one or more validations failed
	 *         (accumulated with the semigroup), otherwise, <code>None</code>.
	 */
	public <A> Option<E> accumulate(final Semigroup<E> s,
			final Validation<E, A> va) {
	 ...
	 *         failing validation with errors accumulated if one or more failed.
	 */
	public <A, B, C> Validation<E, C> accumulate(final Semigroup<E> s,
			final Validation<E, A> va, final Validation<E, B> vb,
			final F<T, F<A, F<B, C>>> f) {
	 ...
	 *         (accumulated with the semigroup), otherwise, <code>None</code>.
	 */
	public <A, B> Option<E> accumulate(final Semigroup<E> s,
			final Validation<E, A> va, final Validation<E, B> vb) {
	 ...
	 *         failing validation with errors accumulated if one or more failed.
	 */
	public <A, B, C, D> Validation<E, D> accumulate(final Semigroup<E> s,
			final Validation<E, A> va, final Validation<E, B> vb,
			final Validation<E, C> vc, final F<T, F<A, F<B, F<C, D>>>> f) {
	...
	public <A, B, C, D> Validation<E, D> accumulate(final Semigroup<E> s,
			final Validation<E, A> va, final Validation<E, B> vb,
			final Validation<E, C> vc, final F4<T, A, B, C, D> f) {
	 ...
	 *         (accumulated with the semigroup), otherwise, <code>None</code>.
	 */
	public <A, B, C> Option<E> accumulate(final Semigroup<E> s,
			final Validation<E, A> va, final Validation<E, B> vb,
	 ...
	 *         failing validation with errors accumulated if one or more failed.
	 */
	public <A, B, C, D, E$> Validation<E, E$> accumulate(final Semigroup<E> s,
			final Validation<E, A> va, final Validation<E, B> vb,
	 ...
	 *         (accumulated with the semigroup), otherwise, <code>None</code>.
	 */
	public <A, B, C, D> Option<E> accumulate(final Semigroup<E> s,
			final Validation<E, A> va, final Validation<E, B> vb,
			final Validation<E, C> vc, final Validation<E, D> vd) {
	 ...
	 *         failing validation with errors accumulated if one or more failed.
	 */
	public <A, B, C, D, E$, F$> Validation<E, F$> accumulate(
			final Semigroup<E> s, final Validation<E, A> va,
	 ...
	 *         (accumulated with the semigroup), otherwise, <code>None</code>.
	 */
	public <A, B, C, D, E$> Option<E> accumulate(final Semigroup<E> s,
			final Validation<E, A> va, final Validation<E, B> vb,
			final Validation<E, C> vc, final Validation<E, D> vd,
			final Validation<E, E$> ve) {
		return accumulate(s, va, vb, vc, vd, ve,
				new F6<T, A, B, C, D, E$, Unit>() {
					public Unit f(final T t, final A a, final B b, final C c,
							final D d, final E$ e) {
						return unit();
					}
	 ...
	 *         failing validation with errors accumulated if one or more failed.
	 */
	public <A, B, C, D, E$, F$, G> Validation<E, G> accumulate(
			final Semigroup<E> s, final Validation<E, A> va,
			final Validation<E, B> vb, final Validation<E, C> vc,
			final Validation<E, D> vd, final Validation<E, E$> ve,
	...
	public <A, B, C, D, E$, F$, G> Validation<E, G> accumulate(
			...
			final Validation<E, B> vb, final Validation<E, C> vc,
			final Validation<E, D> vd, final Validation<E, E$> ve,
			final Validation<E, F$> vf, final F7<T, A, B, C, D, E$, F$, G> f) {
	 ...
	 *         (accumulated with the semigroup), otherwise, <code>None</code>.
	 */
	public <A, B, C, D, E$, F$> Option<E> accumulate(final Semigroup<E> s,
			final Validation<E, A> va, final Validation<E, B> vb,
			final Validation<E, C> vc, final Validation<E, D> vd,
			final Validation<E, E$> ve, final Validation<E, F$> vf) {
		return accumulate(s, va, vb, vc, vd, ve, vf,
				new F7<T, A, B, C, D, E$, F$, Unit>() {
					public Unit f(final T t, final A a, final B b, final C c,
	 ...
	 *         failing validation with errors accumulated if one or more failed.
	 */
	public <A, B, C, D, E$, F$, G, H> Validation<E, H> accumulate(
			final Semigroup<E> s, final Validation<E, A> va,
			final Validation<E, B> vb, final Validation<E, C> vc,
			final Validation<E, D> vd, final Validation<E, E$> ve,
	...
	public <A, B, C, D, E$, F$, G, H> Validation<E, H> accumulate(
		...
		return vg
				.accumapply(s, accumulate(s, va, vb, vc, vd, ve, vf, curry(f)));
	}
	 ...
	 *         (accumulated with the semigroup), otherwise, <code>None</code>.
	 */
	public <A, B, C, D, E$, F$, G> Option<E> accumulate(final Semigroup<E> s,
			final Validation<E, A> va, final Validation<E, B> vb,
			final Validation<E, C> vc, final Validation<E, D> vd,
			final Validation<E, E$> ve, final Validation<E, F$> vf,
			final Validation<E, G> vg) {
		return accumulate(s, va, vb, vc, vd, ve, vf, vg,
				new F8<T, A, B, C, D, E$, F$, G, Unit>() {
					public Unit f(final T t, final A a, final B b, final C c,
	...
	/**
	 * Returns an iterator for this validation. This method exists to permit the
	...
	public final class FailProjection<E, T> implements Iterable<E> {
		...
		/**
		 * The failing value or the application of the given function to the
		 * success value.
		 * 
		 * @param f
		 *            The function to execute on the success value.
		 * @return The failing value or the application of the given function to
		 *         the success value.
		 */
		...
		/**
		 * Binds the given function across this validation's failing value if it
		 * has one.
		 * 
		 * @param f
		 *            The function to bind across this validation.
		...
		public <A> Validation<A, T> bind(final F<E, Validation<A, T>> f) {
			return v.isFail() ? f.f(v.fail()) : Validation.<A, T> success(v
					.success());
		}

		/**
		 * Performs a bind across the validation, but ignores the element value
		 * in the function.
		 * 
		 * @param v
		...
		/**
		 * Returns <code>None</code> if this is a success or if the given
		 * predicate <code>p</code> does not hold for the failing value,
		 * otherwise, returns a fail in <code>Some</code>.
		 * 
		 * @param f
		 *            The predicate function to test on this failing value.
		 * @return <code>None</code> if this is a success or if the given
		 *         predicate <code>p</code> does not hold for the failing value,
		 *         otherwise, returns a fail in <code>Some</code>.
		 */
		public <A> Option<Validation<E, A>> filter(final F<E, Boolean> f) {
			return v.toEither().left().<A> filter(f)
					.map(Validation.<E, A> validation());
		}
		 ...
		 * 
		 * @param v
		 *            The validation of the function to apply on the failing
		 *            value.
		 * @return The result of function application in validation.
		 */
		public <A> Validation<A, T> apply(final Validation<F<E, A>, T> v) {
			return v.f().bind((F<E, A> f) -> map(f));
		}

		/**
		 * Returns <code>true</code> if this is a success or returns the result
		 * of the application of the given function to the failing value.
		 * 
		 * @param f
		 *            The predicate function to test on this failing value.
		 * @return <code>true</code> if this is a success or returns the result
		 *         of the application of the given function to the failing
		 *         value.
		 */
		...
		/**
		 * Returns <code>false</code> if this is a success or returns the result
		 * of the application of the given function to the failing value.
		 * 
		 * @param f
		 *            The predicate function to test on this failing value.
		 * @return <code>false</code> if this is a success or returns the result
		 *         of the application of the given function to the failing
		 *         value.
		 */
		...
		/**
		 * Returns a single element list if this is a failing value, otherwise
		 * an empty list.
		 * 
		 * @return A single element list if this is a failing value, otherwise
		 *         an empty list.
		 */
		...
		/**
		 * Returns the failing value in <code>Some</code> if there is one,
		 * otherwise <code>None</code>.
		 * 
		 * @return The failing value in <code>Some</code> if there is one,
		 *         otherwise <code>None</code>.
		 */
		...
		/**
		 * Returns a single element array if this is a failing value, otherwise
		 * an empty list.
		 * 
		 * @return A single element array if this is a failing value, otherwise
		 *         an empty list.
		 */
		...
		/**
		 * Returns a single element stream if this is a failing value, otherwise
		 * an empty list.
		 * 
		 * @return A single element stream if this is a failing value, otherwise
		 *         an empty list.
		 */
		...
		/**
		 * Returns an iterator for this projection. This method exists to permit
		 * the use in a <code>for</code>-each loop.
		 * 
	 ...
	 * 
	 * @return A validation with its failing value in a non-empty list if there
	 *         is one.
	 */
	@SuppressWarnings({ "unchecked" })
	public Validation<NonEmptyList<E>, T> nel() {
		return isSuccess() ? Validation.<NonEmptyList<E>, T> success(success())
				: Validation
						.<NonEmptyList<E>, T> fail(NonEmptyList.nel(fail()));
	}
	...
	/**
	 * Returns a failing validation containing a non-empty list that contains
	 * the given value.
	 * 
	 * @param e
	 *            The value to use in a non-empty list for the failing
	 *            validation.
	 * @return A failing validation containing a non-empty list that contains
	 *         the given value.
	 */
	...
	/**
	 * Returns a validation based on a boolean condition. If the condition is
	 * <code>true</code>, the validation succeeds, otherwise it fails.
	 * 
	 * @param c
	 *            The condition to base the returned validation on.
	 * @param e
	 *            The failing value to use if the condition is
	 *            <code>false</code>.
	 * @param t
	 *            The succeeding value to use if the condition is
	 *            <code>true</code>.
	 * @return A validation based on a boolean condition.
	 */
	public static <E, T> Validation<E, T> condition(final boolean c, final E e,
			final T t) {
	 ...
	 */
	public static Validation<NumberFormatException, Byte> parseByte(
			final String s) {
		try {
	 ...
	 */
	public static Validation<NumberFormatException, Double> parseDouble(
			final String s) {
		try {
	 ...
	 */
	public static Validation<NumberFormatException, Float> parseFloat(
			final String s) {
		try {
	 ...
	 */
	public static Validation<NumberFormatException, Integer> parseInt(
			final String s) {
		try {
	 ...
	 */
	public static Validation<NumberFormatException, Long> parseLong(
			final String s) {
		try {
	 ...
	 */
	public static Validation<NumberFormatException, Short> parseShort(
			final String s) {
		try {
