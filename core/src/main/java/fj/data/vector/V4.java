...
public final class V4<A> implements Iterable<A> {
	 ...
	 * 
	 * @param p
	 *            The product-4 from which to create a vector.
	...
	public <B> V4<B> apply(final V4<F<A, B>> vf) {
		return new V4<B>(P1.<A, B> apply(head, vf.head()),
				tail.apply(vf.tail()));
	}
	...
	/**
	 * Returns a function that transforms a vector-4 to a stream of its
	 * elements.
	 * 
	 * @return a function that transforms a vector-4 to a stream of its
	 *         elements.
	 */
	...
	/**
	 * Returns a function that transforms a vector-4 to the equivalent
	 * product-4.
	 * 
	 * @return a function that transforms a vector-4 to the equivalent
	 *         product-4.
	 */
