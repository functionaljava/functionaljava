...
public final class V7<A> implements Iterable<A> {
	 ...
	 * 
	 * @param p
	 *            The product-7 from which to create a vector.
	 ...
	 * @param tail
	 *            The vector representing all but the first element of the new
	 *            vector.
	 ...
	 * @return A new vector after the given function has been applied to each
	 *         element.
	 */
	...
	/**
	 * Performs function application within a vector (applicative functor
	 * pattern).
	 * 
	 * @param vf
	 *            The vector of functions to apply.
	 * @return A new vector after zipping the given vector of functions over
	 *         this vector.
	 */
	public <B> V7<B> apply(final V7<F<A, B>> vf) {
		return new V7<B>(P1.<A, B> apply(head, vf.head()),
				tail.apply(vf.tail()));
	}

	/**
	 * Zips this vector with the given vector using the given function to
	 ...
	 * @param bs
	 *            The vector to zip this vector with.
	 * @return A new vector with a length the same as the shortest of this
	...
	/**
	 * Returns a function that transforms a vector-7 to a stream of its
	 * elements.
	 * 
	 * @return a function that transforms a vector-7 to a stream of its
	 *         elements.
	 */
	...
	/**
	 * Returns a function that transforms a vector-7 to the equivalent
	 * product-7.
	 * 
	 * @return a function that transforms a vector-7 to the equivalent
	 *         product-7.
	 */
