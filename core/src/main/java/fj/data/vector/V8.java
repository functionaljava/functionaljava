...
public final class V8<A> implements Iterable<A> {
	...
	public <B> V8<B> apply(final V8<F<A, B>> vf) {
		return new V8<B>(P1.<A, B> apply(head, vf.head()),
				tail.apply(vf.tail()));
	}
	...
	/**
	 * Returns a function that transforms a vector-8 to a stream of its
	 * elements.
	 * 
	 * @return a function that transforms a vector-8 to a stream of its
	 *         elements.
	 */
	...
	/**
	 * Returns a function that transforms a vector-8 to the equivalent
	 * product-8.
	 * 
	 * @return a function that transforms a vector-8 to the equivalent
	 *         product-8.
	 */
