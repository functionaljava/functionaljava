...
/**
 * Determines how the elements of a tree are measured and how measures are
 * summed. Consists of a monoid and a measuring function. Different instances of
 * this class will result in different behaviours for the tree.
 */
public final class Measured<V, A> {
	...
	public static <V, A> Measured<V, A> measured(final Monoid<V> m,
			final F<A, V> measure) {
