...
public final class Natural extends Number {
	 ...
	 * @param i
	 *            A given BigInteger
	 * @return An optional natural number, or none if the given BigInteger is
	 *         less than zero.
	 */
	public static Option<Natural> natural(final BigInteger i) {
		return i.compareTo(BigInteger.ZERO) < 0 ? Option.<Natural> none()
	 ...
	 */
	public static final F<BigInteger, Option<Natural>> fromBigInt = Natural::natural;
	 ...
	 * @param i
	 *            A given long
	 * @return An optional natural number, or none if the given long is less
	 *         than zero.
	 */
	 ...
	 * 
	 * @return A function that returns the predecessor of a given natural
	 *         number, or None if it's zero.
	 */
	 ...
	 */
	public static final F<Natural, F<Natural, Natural>> add = curry((n1, n2) -> n1
			.add(n2));
	 ...
	 * @return The difference between the two numbers, if this number is larger
	 *         than the given one. Otherwise none.
	 */
	 ...
	 */
	public static final F<Natural, F<Natural, Option<Natural>>> subtract = curry((o,o1) -> o1.subtract(o));
	 ...
	 */
	public static final F<Natural, F<Natural, Natural>> divide = curry((n1,n2) -> n2.divide(n1));
	 ...
	 * @return The quotient of this number and the highest number, less than or
	 *         equal to the given number, that divides this number.
	 */
	...
	/**
	 * A function that yields the remainder of division of its second argument
	 * by its first.
	 */
	public static final F<Natural, F<Natural, Natural>> mod = curry((n1,n2) -> n2.mod(n1));

	/**
	 * Divide a natural number by another yielding both the quotient and the
	 * remainder.
	 * 
	 * @param n
	 *            A natural number to divide this one by.
	...
	/**
	 * A function that divides its second argument by its first, yielding both
	 * the quotient and the remainder.
	 */
	public static final F<Natural, F<Natural, V2<Natural>>> divmod = curry((n1,n2) -> n2.divmod(n1));
