...
/**
 * An optional value that may be none (no value) or some (a value). This type is
 * a replacement for the use of <code>null</code> with better type checks.
 * 
...
public abstract class Option<A> implements Iterable<A> {
	...
	/**
	 * Returns an iterator for this optional value. This method exists to permit
	...
	/**
	 * Returns the value from this optional value, or fails if there is no
	 * value.
	 * 
	 * @return The value from this optional value, or fails if there is no
	 *         value.
	 */
	public abstract A some();

	/**
	 * Returns <code>true</code> if this optional value has a value,
	 * <code>false</code> otherwise.
	 * 
	 * @return <code>true</code> if this optional value has a value,
	 *         <code>false</code> otherwise.
	 */
	...
	/**
	 * Returns <code>false</code> if this optional value has a value,
	 * <code>true</code> otherwise.
	 * 
	 * @return <code>false</code> if this optional value has a value,
	 *         <code>true</code> otherwise.
	 */
	 ...
	 * 
	 * @return A function that returns true if a given optional value has a
	 ...
	 * 
	 * @return A function that returns false if a given optional value has a
	 ...
	 * 
	 * @param b
	 *            The value to return if this optional value has no value.
	 * @param f
	...
	/**
	 * Returns the length of this optional value; 1 if there is a value, 0
	 * otherwise.
	 * 
	 * @return The length of this optional value; 1 if there is a value, 0
	 *         otherwise.
	 */
	 ...
	 * @return A new optional value after the given function has been applied to
	 *         its element.
	 */
	 ...
	 * 
	 * @return A function that maps a given function across a given optional
	 *         value.
	 */
	...
	/**
	 * Filters elements from this optional value by returning only elements
	 * which produce <code>true</code> when the given function is applied to
	 * them.
	 * 
	 * @param f
	 *            The predicate function to filter on.
	 * @return A new optional value whose value matches the given predicate if
	 *         it has one.
	 */
	public final Option<A> filter(final F<A, Boolean> f) {
		return isSome() ? f.f(some()) ? this : Option.<A> none() : Option
				.<A> none();
	}

	/**
	 * Binds the given function across the element of this optional value with a
	 * final join.
	 * 
	 * @param f
	...
	/**
	 * Binds the given function across the element of this optional value and
	 * the given optional value with a final join.
	 * 
	 * @param ob
	 ...
	 * @return A new optional value after performing the map, then final join.
	 */
	public final <B, C, D> Option<D> bind(final Option<B> ob,
			final Option<C> oc, final F<A, F<B, F<C, D>>> f) {
	 ...
	 * @return A new optional value after performing the map, then final join.
	 */
	public final <B, C, D, E> Option<E> bind(final Option<B> ob,
			final Option<C> oc, final Option<D> od,
	 ...
	 * @return A new optional value after performing the map, then final join.
	 */
	public final <B, C, D, E, F$> Option<F$> bind(final Option<B> ob,
			final Option<C> oc, final Option<D> od, final Option<E> oe,
	 ...
	 * @return A new optional value after performing the map, then final join.
	 */
	public final <B, C, D, E, F$, G> Option<G> bind(final Option<B> ob,
			final Option<C> oc, final Option<D> od, final Option<E> oe,
			final Option<F$> of, final F<A, F<B, F<C, F<D, F<E, F<F$, G>>>>>> f) {
	 ...
	 * @return A new optional value after performing the map, then final join.
	 */
	public final <B, C, D, E, F$, G, H> Option<H> bind(final Option<B> ob,
			final Option<C> oc, final Option<D> od, final Option<E> oe,
	 ...
	 * @return A new optional value after performing the map, then final join.
	 */
	public final <B, C, D, E, F$, G, H, I> Option<I> bind(final Option<B> ob,
			final Option<C> oc, final Option<D> od, final Option<E> oe,
			final Option<F$> of, final Option<G> og, final Option<H> oh,
	...
	public final <B, C> Option<P3<A, B, C>> bindProduct(final Option<B> ob,
			final Option<C> oc) {
		return bind(ob, oc, P.<A, B, C> p3());
	}

	public final <B, C, D> Option<P4<A, B, C, D>> bindProduct(
			final Option<B> ob, final Option<C> oc, final Option<D> od) {
		return bind(ob, oc, od, P.<A, B, C, D> p4());
	}

	public final <B, C, D, E> Option<P5<A, B, C, D, E>> bindProduct(
			final Option<B> ob, final Option<C> oc, final Option<D> od,
			final Option<E> oe) {
		return bind(ob, oc, od, oe, P.<A, B, C, D, E> p5());
	}

	public final <B, C, D, E, F$> Option<P6<A, B, C, D, E, F$>> bindProduct(
			final Option<B> ob, final Option<C> oc, final Option<D> od,
			final Option<E> oe, final Option<F$> of) {
		return bind(ob, oc, od, oe, of, P.<A, B, C, D, E, F$> p6());
	}

	public final <B, C, D, E, F$, G> Option<P7<A, B, C, D, E, F$, G>> bindProduct(
			final Option<B> ob, final Option<C> oc, final Option<D> od,
			final Option<E> oe, final Option<F$> of, final Option<G> og) {
		return bind(ob, oc, od, oe, of, og, P.<A, B, C, D, E, F$, G> p7());
	}

	public final <B, C, D, E, F$, G, H> Option<P8<A, B, C, D, E, F$, G, H>> bindProduct(
			final Option<B> ob, final Option<C> oc, final Option<D> od,
			final Option<E> oe, final Option<F$> of, final Option<G> og,
			final Option<H> oh) {
		return bind(ob, oc, od, oe, of, og, oh,
				P.<A, B, C, D, E, F$, G, H> p8());
	}

	/**
	 * Performs a bind across the optional value, but ignores the element value
	 * in the function.
	 * 
	 * @param o
	...
	/**
	 * Performs function application within an optional value (applicative
	 * functor pattern).
	 * 
	 * @param of
	 *            The optional value of functions to apply.
	 * @return A new optional value after applying the given optional value of
	 *         functions through this optional value.
	 */
	...
	/**
	 * Returns this optional value if there is one, otherwise, returns the
	 * argument optional value.
	 * 
	 * @param o
	 *            The optional value to return if this optional value has no
	 *            value.
	 * @return This optional value if there is one, otherwise, returns the
	 *         argument optional value.
	 */
	...
	/**
	 * Returns an either projection of this optional value; the given argument
	 * in <code>Left</code> if no value, or the value in <code>Right</code>.
	 * 
	 * @param x
	 *            The value to return in left if this optional value has no
	 *            value.
	 ...
	 * 
	 * @return A function that returns an either projection of a given optional
	 *         value, given a value to return in left.
	 */
	...
	public final Array<A> toArray(final Class<A[]> c) {
		if (isSome()) {
			final A[] a = (A[]) java.lang.reflect.Array.newInstance(
					c.getComponentType(), 1);
			a[0] = some();
			return Array.array(a);
		} else
			return Array.array((A[]) java.lang.reflect.Array.newInstance(
					c.getComponentType(), 0));
	}
	...
	/**
	 * Returns the value from this optional value, or if there is no value,
	 * returns <code>null</code>. This is intended for interfacing with APIs
	 * that expect a <code>null</code> for non-existence.
	 * 
	...
	/**
	 * Returns <code>true</code> if this optional value has no value, or the
	 * predicate holds for the given predicate function, <code>false</code>
	 * otherwise.
	 * 
	 * @param f
	 *            the predicate function to test on the value of this optional
	 *            value.
	 * @return <code>true</code> if this optional value has no value, or the
	...
	/**
	 * Returns <code>true</code> is this optional value has a value and the
	 * given predicate function holds on that value, <code>false</code>
	 * otherwise.
	 * 
	 * @param f
	 *            the predicate function to test on the value of this optional
	 *            value.
	 * @return <code>true</code> is this optional value has a value and the
	 *         given predicate function holds on that value, <code>false</code>
	 *         otherwise.
	 */
	...
	/**
	 * Turns an unsafe nullable value into a safe optional value. If
	 * <code>t == null</code> then return none, otherwise, return the given
	 * value in some.
	 * 
	 * @param t
	 *            The unsafe nullable value.
	 * @return If <code>t == null</code> then return it in some, otherwise,
	 *         return none.
	 */
	 ...
	 * @return A new optional value that is the join of the given optional
	 *         value.
	 */
	...
	public static <A> Option<List<A>> sequence(final List<Option<A>> a) {
		return a.isEmpty() ? some(List.<A> nil()) : a.head().bind(
				aa -> sequence(a.tail()).map(cons_(aa)));
	}

	/**
	 * Returns an optional value that has a value of the given argument, if the
	 * given predicate holds on that argument, otherwise, returns no value.
	 * 
	 * @param f
	 *            The predicate to test on the given argument.
	 * @param a
	 *            The argument to test the predicate on and potentially use as
	 *            the value of the returned optional value.
	 * @return an optional value that has a value of the given argument, if the
	 *         given predicate holds on that argument, otherwise, returns no
	 *         value.
	 */
	...
	/**
	 * Returns an optional value that has a value of the given argument if the
	 * given boolean is true, otherwise, returns no value.
	 * 
	 * @param p
	 *            The value to be true to return the given value.
	 * @param a
	 *            the value to return in an optional value if the given boolean
	 *            is true.
	 * @return An optional value that has a value of the given argument if the
	 *         given boolean is true, otherwise, returns no value.
	 */
	 ...
	 * 
	 * @return a function that returns an optional value that has a value of the
	 *         given argument, if the given predicate holds on that argument, or
	 *         no value otherwise.
	 */
	...
	/**
	 * Returns an optional non-empty string, or no value if the given string is
	 * empty.
	 * 
	 * @param s
	 *            A string to turn into an optional non-empty string.
	 * @return an optional non-empty string, or no value if the given string is
	 *         empty.
	 */
	public static Option<String> fromString(final String s) {
		return fromNull(s).bind(sa -> {
				final Option<String> none = none();
				return sa.length() == 0 ? none : some(sa);
		});
	}

	/**
	 * Returns a function that transforms a string to an optional non-empty
	 * string, or no value if the string is empty.
	 * 
	 * @return a function that transforms a string to an optional non-empty
	 *         string, or no value if the string is empty.
	 */
	...
	/**
	 * Returns a function that takes an optional value to a value or errors if
	 * there is no value.
	 * 
	 * @return A function that takes an optional value to a value or errors if
	 *         there is no value.
	 */
	 ...
	 */
	public static <A, B, C> F<Option<A>, F<Option<B>, Option<C>>> liftM2(
			final F<A, F<B, C>> f) {
	 ...
	 * 
	 * @return A function that binds a given function across an option with a
	 *         final join.
	 */
	public static <A, B> F<F<A, Option<B>>, F<Option<A>, Option<B>>> bind() {
		return curry((F<A, Option<B>> f, Option<A> a) -> a.bind(f));
	}

	/**
	 * First-class join function.
	 * 
	 * @return A function that joins an Option of an Option to make a single
	 *         Option.
	 */
	 ...
	 */
	public static final F<String, Option<Byte>> parseByte = s -> parseByte(s)
			.toOption();

	/**
	 * A function that parses a string to a double.
	 */
	public static final F<String, Option<Double>> parseDouble = s -> parseDouble(
			s).toOption();

	/**
	 * A function that parses a string to a float.
	 */
	public static final F<String, Option<Float>> parseFloat = s -> parseFloat(s)
			.toOption();

	/**
	 * A function that parses a string to an integer.
	 */
	public static final F<String, Option<Integer>> parseInt = s -> parseInt(s)
			.toOption();

	/**
	 * A function that parses a string to a long.
	 */
	public static final F<String, Option<Long>> parseLong = s -> parseLong(s)
			.toOption();

	/**
	 * A function that parses a string to a short.
	 */
	public static final F<String, Option<Short>> parseShort = s -> parseShort(s)
			.toOption();
}
