...
public abstract class List<A> implements Iterable<A> {
	...
	/**
	 * Returns an iterator for this list. This method exists to permit the use
	...
	/**
	 * Returns <code>true</code> if this list is empty, <code>false</code>
	 * otherwise.
	 * 
	...
	/**
	 * Returns <code>false</code> if this list is empty, <code>true</code>
	 * otherwise.
	 * 
	 * @return <code>false</code> if this list is empty, <code>true</code>
	 *         otherwise.
	 */
	 ...
	 * @param cons
	 *            The function to apply to the head and tail of this list if it
	 *            is not empty.
	...
	/**
	 * Returns the head of this list if there is one or the given argument if
	 * this list is empty.
	 * 
	 * @param a
	 *            The argument to return if this list is empty.
	 * @return The head of this list if there is one or the given argument if
	 *         this list is empty.
	 */
	...
	/**
	 * Returns the tail of this list if there is one or the given argument if
	 * this list is empty.
	 * 
	 * @param as
	 *            The argument to return if this list is empty.
	 * @return The tail of this list if there is one or the given argument if
	 *         this list is empty.
	 */
	...
	/**
	 * Returns an option projection of this list; <code>None</code> if empty, or
	 * the first element in <code>Some</code>.
	 * 
	...
	/**
	 * Prepends (cons) the given element to this list to product a new list.
	 * This method is added to prevent conflict with overloads.
	 * 
	 * @param a
	 *            The element to prepend.
	 * @return A new list with the given element at the head.
	...
	/**
	 * Filters elements from this list by returning only elements which produce
	 * <code>false</code> when the given function is applied to them.
	 * 
	 * @param f
	 *            The predicate function to filter on.
	...
	/**
	 * Removes the first element that equals the given object. To remove all
	 * matches, use <code>removeAll(e.eq(a))</code>
	 * 
	 * @param a
	 *            The element to remove
	 * @param e
	 *            An <code>Equals</code> instance for the element's type.
	 * @return A new list whose elements do not match the given predicate.
	 */
	...
	/**
	 * Returns the first elements of the head of this list that match the given
	 * predicate function.
	 * 
	 * @param f
	 *            The predicate function to apply on this list until it finds an
	 *            element that does not hold, or the list is exhausted.
	 * @return The first elements of the head of this list that match the given
	 *         predicate function.
	 */
	...
	/**
	 * Removes elements from the head of this list that do not match the given
	 * predicate function until an element is found that does match or the list
	 * is exhausted.
	 * 
	 * @param f
	 *            The predicate function to apply through this list.
	 * @return The list whose first element does not match the given predicate
	 *         function.
	 */
	 ...
	 * list that satisfies the given predicate and the second element is the
	 ...
	 *         list that satisfies the given predicate and the second element is
	...
	/**
	 * Returns a tuple where the first element is the longest prefix of this
	 * list that does not satisfy the given predicate and the second element is
	 * the remainder of the list.
	 * 
	 * @param p
	 *            A predicate for an element to not satisfy by a prefix of this
	 *            list.
	 * @return A tuple where the first element is the longest prefix of this
	 *         list that does not satisfy the given predicate and the second
	...
	/**
	 * Binds the given function across each element of this list with a final
	 * join.
	 * 
	 * @param f
	...
	/**
	 * Binds the given function across each element of this list and the given
	 * list with a final join.
	 * 
	 * @param lb
	 *            A given list to bind the given function with.
	 * @param f
	 *            The function to apply to each element of this list and the
	 *            given list.
	 * @return A new list after performing the map, then final join.
	 */
	 ...
	 * 
	 * @param f
	 *            The function to promote to a function on lists.
	 * @return The given function, promoted to operate on lists.
	 */
	public static <A, B, C> F<List<A>, F<List<B>, List<C>>> liftM2(
			final F<A, F<B, C>> f) {
	 ...
	 * @return A new list after performing the map, then final join.
	 */
	public final <B, C, D> List<D> bind(final List<B> lb, final List<C> lc,
	 ...
	 * @return A new list after performing the map, then final join.
	 */
	public final <B, C, D, E> List<E> bind(final List<B> lb, final List<C> lc,
			final List<D> ld, final F<A, F<B, F<C, F<D, E>>>> f) {
	 ...
	 * @return A new list after performing the map, then final join.
	 */
	public final <B, C, D, E, F$> List<F$> bind(final List<B> lb,
			final List<C> lc, final List<D> ld, final List<E> le,
	 ...
	 * @return A new list after performing the map, then final join.
	 */
	public final <B, C, D, E, F$, G> List<G> bind(final List<B> lb,
			final List<C> lc, final List<D> ld, final List<E> le,
	 ...
	 * @return A new list after performing the map, then final join.
	 */
	public final <B, C, D, E, F$, G, H> List<H> bind(final List<B> lb,
			final List<C> lc, final List<D> ld, final List<E> le,
	 ...
	 * @return A new list after performing the map, then final join.
	 */
	public final <B, C, D, E, F$, G, H, I> List<I> bind(final List<B> lb,
			final List<C> lc, final List<D> ld, final List<E> le,
	...
	/**
	 * Performs a bind across each list element, but ignores the element value
	 * each time.
	 * 
	 * @param bs
	...
	/**
	 * Performs function application within a list (applicative functor
	 * pattern).
	 * 
	 * @param lf
	 *            The list of functions to apply.
	 * @return A new list after applying the given list of functions through
	 *         this list.
	 */
	...
	/**
	 * Performs a right-fold reduction across this list. This function uses
	 ...
	 * @param b
	 *            The beginning value to start the application from.
	 * @return A Trampoline containing the final result after the right-fold
	 *         reduction.
	 */
	public final <B> Trampoline<B> foldRightC(final F2<A, B, B> f, final B b) {
		return Trampoline.suspend(new P1<Trampoline<B>>() {
			public Trampoline<B> _1() {
				return isEmpty() ? Trampoline.pure(b) : tail().foldRightC(f, b)
						.map(f.f(head()));
			}
		});
	}
	...
	/**
	 * Performs a left-fold reduction across this list. This function runs in
	 * constant space.
	 * 
	 * @param f
	 *            The function to apply on each element of the list.
	...
	public final A index(final int i) {
		if (i < 0 || i > length() - 1)
			throw error("index " + i + " out of range on list with length "
					+ length());
		else {
			List<A> xs = this;
	...
	/**
	 * Takes the given number of elements from the head of this list if they are
	 * available.
	 * 
	 * @param i
	...
	public final List<A> take(final int i) {
		return i <= 0 || isEmpty() ? List.<A> nil() : cons(head(),
				tail().take(i - 1));
	}

	/**
	 * Drops the given number of elements from the head of this list if they are
	 * available.
	 * 
	 * @param i
	...
	/**
	 * Splits this list into two lists at the given index. If the index goes out
	 * of bounds, then it is normalised so that this function never fails.
	 * 
	 * @param i
	...
	public final P2<List<A>, List<A>> splitAt(final int i) {
		...
		for (List<A> xs = this; xs.isNotEmpty(); xs = xs.tail()) {
			final A h = xs.head();
			s = c < i ? s.map1(as -> as.snoc(h)) : s.map2(as -> as.snoc(h));
			c++;
		}
	...
	/**
	 * Splits this list into lists of the given size. If the size of this list
	 * is not evenly divisible by the given number, the last partition will
	...
	/**
	 * Sorts this list using the given order over elements using a
	 * <em>merge sort</em> algorithm.
	 * 
	 * @param o
		...
		if (isEmpty())
			...
			final class Merge<A> {
				List<A> merge(final List<A> xs, final List<A> ys, final Ord<A> o) {
					return xs.isEmpty() ? ys : ys.isEmpty() ? xs : o
							.isLessThan(xs.head(), ys.head()) ? cons(xs.head(),
							merge(xs.tail(), ys, o)) : cons(ys.head(),
							merge(xs, ys.tail(), o));
				}
			}
	...
	/**
	 * Zips this list with the given list using the given function to produce a
	 * new list. If this list and the given list have different lengths, then
	 * the longer list is normalised so this function never fails.
	 * 
	 * @param bs
	 *            The list to zip this list with.
	 * @param f
	 *            The function to zip this list and the given list with.
	 * @return A new list with a length the same as the shortest of this list
	 *         and the given list.
	 */
	public final <B, C> List<C> zipWith(final List<B> bs, final F<A, F<B, C>> f) {
		return isEmpty() || bs.isEmpty() ? List.<C> nil() : cons(
				f.f(head()).f(bs.head()), tail().zipWith(bs.tail(), f));
	}
	...
	/**
	 * Zips this list with the given list to produce a list of pairs. If this
	 * list and the given list have different lengths, then the longer list is
	 ...
	 * of this list, <code>false</code> otherwise (<code>true</code> for the
	 * empty list).
	 * 
	 * @param f
	 ...
	 *         of this list, <code>false</code> otherwise.
	 */
	 ...
	 * elements of this list, <code>false</code> otherwise (<code>false</code>
	 * for the empty list).
	 * 
	 * @param f
	...
	public final List<A> intersperse(final A a) {
		return isEmpty() || tail().isEmpty() ? this : cons(head(),
				cons(a, tail().intersperse(a)));
	}
	...
	/**
	 * Removes duplicates according to the given ordering. This function is
	 * O(n).
	 * 
	 * @param o
	...
	/**
	 * Returns a new list of all the items in this list that do not appear in
	 * the given list.
	 * 
	 * @param eq
	 *            an equality for the items of the lists.
	 * @param xs
	 *            a list to subtract from this list.
	 * @return a list of all the items in this list that do not appear in the
	 *         given list.
	 */
	public final List<A> minus(final Equal<A> eq, final List<A> xs) {
		return removeAll(compose(Monoid.disjunctionMonoid.sumLeft(),
				xs.mapM(curry(eq.eq()))));
	}

	/**
	 * Maps the given function of arity-2 across this list and returns a
	...
	/**
	 * Maps the given function across this list by binding through the Option
	 * monad.
	 * 
	 * @param f
	...
	/**
	 * Maps the given function across this list by binding through the
	 * Trampoline monad.
	 * 
	 * @param f
	 *            The function to apply through the this list.
	...
	/**
	 * Returns the index of the first element in this list which is equal (by
	 * the given equality) to the query element, or None if there is no such
	 * element.
	 * 
	 * @param e
	 *            An equality for this list's elements.
	 * @param a
	 *            A query element.
	 * @return The index of the first element in this list which is equal (by
	 *         the given equality) to the query element, or None if there is no
	 *         such element.
	 */
	 ...
	 * 
	 * @return The last element of this list or throws an error if this list is
	 *         empty.
	 */
	public final A last() {
		A a = head();
	...
	/**
	 * Returns all but the last element of this list. Undefiend for the empty
	 * list.
	 * 
	 * @return All but the last element of this list. Undefiend for the empty
	 *         list.
	 */
	...
	/**
	 * Inserts the given element before the first element that is greater than
	 * or equal to it according to the given ordering.
	 * 
	 * @param f
	 *            An ordering function to compare elements.
	 * @param x
	 *            The element to insert.
	 * @return A new list with the given element inserted before the first
	 *         element that is greater than or equal to it according to the
	 *         given ordering.
	 */
	...
	public final A mode(final Ord<A> o) {
		return sort(o).group(o.equal())
				.maximum(intOrd.comap(List.<A> length_())).head();
	}

	/**
	 * Returns whether or not all elements in the list are equal according to
	 * the given equality test.
	 * 
	 * @param eq
	 *            The equality test.
	 * @return Whether or not all elements in the list are equal according to
	 *         the given equality test.
	 */
	public boolean allEqual(final Equal<A> eq) {
		return isEmpty() || tail().isEmpty() || eq.eq(head(), tail().head())
				&& tail().allEqual(eq);
	}
	...
	/**
	 * Returns a function that prepends (cons) an element to a list to produce a
	 * new list.
	 * 
	 * @return A function that prepends (cons) an element to a list to produce a
	 *         new list.
	 */
	 ...
	 * @return A new list that is a result of unfolding until the function does
	 *         not produce a value.
	 */
	public static <A, B> List<A> unfold(final F<B, Option<P2<A, B>>> f,
			final B b) {
		Buffer<A> buf = empty();
	 ...
	 * 
	 * @param from
	 *            The minimum value for the list (inclusive).
	 * @param to
	 *            The maximum value for the list (exclusive).
	 * @return A list of integers from the given <code>from</code> value
	 *         (inclusive) to the given <code>to</code> value (exclusive).
	 */
	public static List<Integer> range(final int from, final int to) {
		return from >= to ? List.<Integer> nil() : cons(from,
				range(from + 1, to));
	}

	/**
	 * Returns a list of characters from the given string. The inverse of this
	 * function is {@link #asString(List)}.
	 * 
	 * @param s
	...
	/**
	 * Returns a string from the given list of characters. The invers of this
	...
	/**
	 * Creates a list where the first item is calculated by applying the
	 ...
	 * @return A list where the first item is calculated by applying the
	 ...
	 * {@link #lookup(Equal, List, Object)}.
	 * 
	 * @param e
	 *            The test for equality on keys.
	 * @return A partially applied version of
	 *         {@link #lookup(Equal , List, Object)}.
	 */
	public static <A, B> F2<List<P2<A, B>>, A, Option<B>> lookup(
			final Equal<A> e) {
	 ...
	 * 
	 * @param fs
	 *            The list of functions to sequence into a single function that
	 *            returns a list.
	 * @return A function that, when given an argument, applies all the
	 *         functions in the given list to it and returns a list of the
	 *         results.
	 */
	public static <A, B> F<B, List<A>> sequence_(final List<F<B, A>> fs) {
		return fs.foldRight(
				Function.<A, List<A>, List<A>, B> lift(List.<A> cons()),
				Function.<B, List<A>> constant(List.<A> nil()));
	}
	...
	/**
	 * A mutable, singly linked list. This structure should be used
	 * <em>very</em> sparingly, in favour of the {@link List immutable singly
	...
	public static final class Buffer<A> implements Iterable<A> {
		...
		/**
		 * Returns an iterator for this buffer. This method exists to permit the
		 * use in a <code>for</code>-each loop.
		 * 
		...
		/**
		 * Appends (snoc) the given element to this buffer to produce a new
		 * buffer.
		 * 
		 * @param a
		 *            The element to append to this buffer.
		 ...
		 * 
		 * @param as
		 *            The buffer to append to this one.
		...
		/**
		 * Returns an immutable list projection of this buffer. Modifications to
		 * the underlying buffer will <em>not</em> be reflected in returned
		 * lists.
		 * 
		 ...
		 * 
		 * @param as
		 *            The list to construct a buffer with.
	...
	/**
	 * Perform an equality test on this list which delegates to the .equals()
	 * method of the member instances. This is implemented with Equal.listEqual
	 * using the anyEqual rule.
	 * 
	 * @param obj
	 *            the other object to check for equality against.
	 * @return true if this list is equal to the provided argument
	 */
	// Suppress the warning for cast to <code>List<A></code> because the type is
	...
	public boolean equals(final Object obj) {
		...
		// Casting to List<A> here does not cause a runtime exception even if
		// the type arguments don't match.
		// The cast is done to avoid the compiler warning
		// "raw use of parameterized class 'List'"
		return Equal.listEqual(Equal.<A> anyEqual()).eq(this, (List<A>) obj);
	}

	/**
	 * Compute the hash code from this list as a function of the hash codes of
	 * its members. Delegates to Hash.listHash, using the anyHash() rule, which
	 * uses the hash codes of the contents.
	 * 
	...
	/**
	 * Obtain a string representation of this list using the toString
	 * implementations of the members. Uses Show.listShow with F2 argument and
	...
	public String toString() {
		return Show.listShow(Show.<A> anyShow()).show(this)
				.foldLeft((s, c) -> s + c, "");
	}
}
