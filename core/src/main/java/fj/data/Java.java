...
public final class Java {
	 ...
	 * 
	 * @param fair
	 *            The argument to pass to the constructor of the array blocking
	 *            queue.
	 * @return A function that converts lists to array blocking queue.
	 */
	public static <A> F<List<A>, ArrayBlockingQueue<A>> List_ArrayBlockingQueue(
			final boolean fair) {
		return as -> new ArrayBlockingQueue<A>(as.length(), fair,
				as.toCollection());
	}
	 ...
	 * 
	 * @param fair
	 *            The argument to pass to the constructor of the synchronous
	 *            queue.
	 * @return A function that converts lists to synchronous queues.
	 */
	public static <A> F<List<A>, SynchronousQueue<A>> List_SynchronousQueue(
			final boolean fair) {
		return as -> {
	 ...
	 */
	public static <A> F<Array<A>, ArrayBlockingQueue<A>> Array_ArrayBlockingQueue(
			final boolean fair) {
		return as -> new ArrayBlockingQueue<A>(as.length(), fair,
				as.toCollection());
	}
	 ...
	 */
	public static <A> F<Array<A>, SynchronousQueue<A>> Array_SynchronousQueue(
			final boolean fair) {
		return as -> {
			final SynchronousQueue<A> q = new SynchronousQueue<A>(fair);
			q.addAll(as.toCollection());
	 ...
	 */
	public static <A> F<Stream<A>, ArrayBlockingQueue<A>> Stream_ArrayBlockingQueue(
			final boolean fair) {
		return as -> new ArrayBlockingQueue<A>(as.length(), fair,
				as.toCollection());
	}
	 ...
	 */
	public static <A> F<Stream<A>, SynchronousQueue<A>> Stream_SynchronousQueue(
			final boolean fair) {
		return as -> {
			final SynchronousQueue<A> q = new SynchronousQueue<A>(fair);
			q.addAll(as.toCollection());
	 ...
	 */
	public static <A> F<Option<A>, ArrayBlockingQueue<A>> Option_ArrayBlockingQueue(
			final boolean fair) {
		return as -> new ArrayBlockingQueue<A>(as.length(), fair,
				as.toCollection());
	}
	 ...
	 */
	public static <A> F<Option<A>, SynchronousQueue<A>> Option_SynchronousQueue(
			final boolean fair) {
		return as -> {
			final SynchronousQueue<A> q = new SynchronousQueue<A>(fair);
			q.addAll(as.toCollection());
	...
	public static <A, B> F<Either<A, B>, ArrayList<A>> Either_ArrayListA() {
		return Function.compose(Java.<A> Option_ArrayList(),
				Conversions.<A, B> Either_OptionA());
	}
	...
	public static <A, B> F<Either<A, B>, ArrayList<B>> Either_ArrayListB() {
		return Function.compose(Java.<B> Option_ArrayList(),
				Conversions.<A, B> Either_OptionB());
	}
	...
	public static <B> F<Either<Boolean, B>, BitSet> Either_BitSetA() {
		return Function.compose(Option_BitSet,
				Conversions.<Boolean, B> Either_OptionA());
	}
	...
	public static <A> F<Either<A, Boolean>, BitSet> Either_BitSetB() {
		return Function.compose(Option_BitSet,
				Conversions.<A, Boolean> Either_OptionB());
	}
	...
	public static <A extends Enum<A>, B> F<Either<A, B>, EnumSet<A>> Either_EnumSetA() {
		return Function.compose(Java.<A> Option_EnumSet(),
				Conversions.<A, B> Either_OptionA());
	}
	...
	public static <A, B extends Enum<B>> F<Either<A, B>, EnumSet<B>> Either_EnumSetB() {
		return Function.compose(Java.<B> Option_EnumSet(),
				Conversions.<A, B> Either_OptionB());
	}
	...
	public static <A, B> F<Either<A, B>, HashSet<A>> Either_HashSetA() {
		return Function.compose(Java.<A> Option_HashSet(),
				Conversions.<A, B> Either_OptionA());
	}
	...
	public static <A, B> F<Either<A, B>, HashSet<B>> Either_HashSetB() {
		return Function.compose(Java.<B> Option_HashSet(),
				Conversions.<A, B> Either_OptionB());
	}
	...
	public static <A, B> F<Either<A, B>, LinkedHashSet<A>> Either_LinkedHashSetA() {
		return Function.compose(Java.<A> Option_LinkedHashSet(),
				Conversions.<A, B> Either_OptionA());
	}
	...
	public static <A, B> F<Either<A, B>, LinkedHashSet<B>> Either_LinkedHashSetB() {
		return Function.compose(Java.<B> Option_LinkedHashSet(),
				Conversions.<A, B> Either_OptionB());
	}
	...
	public static <A, B> F<Either<A, B>, LinkedList<A>> Either_LinkedListA() {
		return Function.compose(Java.<A> Option_LinkedList(),
				Conversions.<A, B> Either_OptionA());
	}
	...
	public static <A, B> F<Either<A, B>, PriorityQueue<A>> Option_PriorityQueueA() {
		return Function.compose(Java.<A> Option_PriorityQueue(),
				Conversions.<A, B> Either_OptionA());
	}
	...
	public static <A, B> F<Either<A, B>, PriorityQueue<B>> Option_PriorityQueueB() {
		return Function.compose(Java.<B> Option_PriorityQueue(),
				Conversions.<A, B> Either_OptionB());
	}
	...
	public static <A, B> F<Either<A, B>, LinkedList<B>> Either_LinkedListB() {
		return Function.compose(Java.<B> Option_LinkedList(),
				Conversions.<A, B> Either_OptionB());
	}
	...
	public static <A, B> F<Either<A, B>, Stack<A>> Either_StackA() {
		return Function.compose(Java.<A> Option_Stack(),
				Conversions.<A, B> Either_OptionA());
	}
	...
	public static <A, B> F<Either<A, B>, Stack<B>> Either_StackB() {
		return Function.compose(Java.<B> Option_Stack(),
				Conversions.<A, B> Either_OptionB());
	}
	...
	public static <A, B> F<Either<A, B>, TreeSet<A>> Either_TreeSetA() {
		return Function.compose(Java.<A> Option_TreeSet(),
				Conversions.<A, B> Either_OptionA());
	}
	...
	public static <A, B> F<Either<A, B>, TreeSet<B>> Either_TreeSetB() {
		return Function.compose(Java.<B> Option_TreeSet(),
				Conversions.<A, B> Either_OptionB());
	}
	...
	public static <A, B> F<Either<A, B>, Vector<A>> Either_VectorA() {
		return Function.compose(Java.<A> Option_Vector(),
				Conversions.<A, B> Either_OptionA());
	}
	...
	public static <A, B> F<Either<A, B>, Vector<B>> Either_VectorB() {
		return Function.compose(Java.<B> Option_Vector(),
				Conversions.<A, B> Either_OptionB());
	}
	 ...
	 */
	public static <A, B> F<Either<A, B>, ArrayBlockingQueue<A>> Either_ArrayBlockingQueueA(
			final boolean fair) {
		return Function.compose(Java.<A> Option_ArrayBlockingQueue(fair),
				Conversions.<A, B> Either_OptionA());
	}
	 ...
	 * @return A function that converts eithers to array blocking queues.
	 */
	public static <A, B> F<Either<A, B>, ArrayBlockingQueue<B>> Either_ArrayBlockingQueueB(
			final boolean fair) {
		return Function.compose(Java.<B> Option_ArrayBlockingQueue(fair),
				Conversions.<A, B> Either_OptionB());
	}
	...
	public static <A, B> F<Either<A, B>, ConcurrentLinkedQueue<A>> Either_ConcurrentLinkedQueueA() {
		return Function.compose(Java.<A> Option_ConcurrentLinkedQueue(),
				Conversions.<A, B> Either_OptionA());
	}
	...
	public static <A, B> F<Either<A, B>, ConcurrentLinkedQueue<B>> Either_ConcurrentLinkedQueueB() {
		return Function.compose(Java.<B> Option_ConcurrentLinkedQueue(),
				Conversions.<A, B> Either_OptionB());
	}
	...
	public static <A, B> F<Either<A, B>, CopyOnWriteArrayList<A>> Either_CopyOnWriteArrayListA() {
		return Function.compose(Java.<A> Option_CopyOnWriteArrayList(),
				Conversions.<A, B> Either_OptionA());
	}
	...
	public static <A, B> F<Either<A, B>, CopyOnWriteArrayList<B>> Either_CopyOnWriteArrayListB() {
		return Function.compose(Java.<B> Option_CopyOnWriteArrayList(),
				Conversions.<A, B> Either_OptionB());
	}
	...
	public static <A, B> F<Either<A, B>, CopyOnWriteArraySet<A>> Either_CopyOnWriteArraySetA() {
		return Function.compose(Java.<A> Option_CopyOnWriteArraySet(),
				Conversions.<A, B> Either_OptionA());
	}
	...
	public static <A, B> F<Either<A, B>, CopyOnWriteArraySet<B>> Either_CopyOnWriteArraySetB() {
		return Function.compose(Java.<B> Option_CopyOnWriteArraySet(),
				Conversions.<A, B> Either_OptionB());
	}
	...
	public static <A extends Delayed, B> F<Either<A, B>, DelayQueue<A>> Either_DelayQueueA() {
		return Function.compose(Java.<A> Option_DelayQueue(),
				Conversions.<A, B> Either_OptionA());
	}
	...
	public static <A, B extends Delayed> F<Either<A, B>, DelayQueue<B>> Either_DelayQueueB() {
		return Function.compose(Java.<B> Option_DelayQueue(),
				Conversions.<A, B> Either_OptionB());
	}
	...
	public static <A, B> F<Either<A, B>, LinkedBlockingQueue<A>> Either_LinkedBlockingQueueA() {
		return Function.compose(Java.<A> Option_LinkedBlockingQueue(),
				Conversions.<A, B> Either_OptionA());
	}
	...
	public static <A, B> F<Either<A, B>, LinkedBlockingQueue<B>> Either_LinkedBlockingQueueB() {
		return Function.compose(Java.<B> Option_LinkedBlockingQueue(),
				Conversions.<A, B> Either_OptionB());
	}
	...
	public static <A, B> F<Either<A, B>, PriorityBlockingQueue<A>> Either_PriorityBlockingQueueA() {
		return Function.compose(Java.<A> Option_PriorityBlockingQueue(),
				Conversions.<A, B> Either_OptionA());
	}
	...
	public static <A, B> F<Either<A, B>, PriorityBlockingQueue<B>> Either_PriorityBlockingQueueB() {
		return Function.compose(Java.<B> Option_PriorityBlockingQueue(),
				Conversions.<A, B> Either_OptionB());
	}
	 ...
	 */
	public static <A, B> F<Either<A, B>, SynchronousQueue<A>> Either_SynchronousQueueA(
			final boolean fair) {
		return Function.compose(Java.<A> Option_SynchronousQueue(fair),
				Conversions.<A, B> Either_OptionA());
	}
	 ...
	 * @return A function that converts eithers to synchronous queues.
	 */
	public static <A, B> F<Either<A, B>, SynchronousQueue<B>> Either_SynchronousQueueB(
			final boolean fair) {
		return Function.compose(Java.<B> Option_SynchronousQueue(fair),
				Conversions.<A, B> Either_OptionB());
	}
	 ...
	 */
	public static final F<String, ArrayList<Character>> String_ArrayList = Function
			.compose(Java.<Character> List_ArrayList(), Conversions.String_List);

	/**
	 * A function that converts strings to hash sets.
	 */
	public static final F<String, HashSet<Character>> String_HashSet = Function
			.compose(Java.<Character> List_HashSet(), Conversions.String_List);

	/**
	 * A function that converts strings to linked hash sets.
	 */
	public static final F<String, LinkedHashSet<Character>> String_LinkedHashSet = Function
			.compose(Java.<Character> List_LinkedHashSet(),
					Conversions.String_List);

	/**
	 * A function that converts strings to linked lists.
	 */
	public static final F<String, LinkedList<Character>> String_LinkedList = Function
			.compose(Java.<Character> List_LinkedList(),
					Conversions.String_List);

	/**
	 * A function that converts strings to priority queues.
	 */
	public static final F<String, PriorityQueue<Character>> String_PriorityQueue = Function
			.compose(Java.<Character> List_PriorityQueue(),
					Conversions.String_List);

	/**
	 * A function that converts strings to stacks.
	 */
	public static final F<String, Stack<Character>> String_Stack = Function
			.compose(Java.<Character> List_Stack(), Conversions.String_List);

	/**
	 * A function that converts strings to tree sets.
	 */
	public static final F<String, TreeSet<Character>> String_TreeSet = Function
			.compose(Java.<Character> List_TreeSet(), Conversions.String_List);

	/**
	 * A function that converts strings to vectors.
	 */
	public static final F<String, Vector<Character>> String_Vector = Function
			.compose(Java.<Character> List_Vector(), Conversions.String_List);
	 ...
	 */
	public static F<String, ArrayBlockingQueue<Character>> String_ArrayBlockingQueue(
			final boolean fair) {
		return Function.compose(Java.<Character> List_ArrayBlockingQueue(fair),
				Conversions.String_List);
	}
	 ...
	 */
	public static final F<String, ConcurrentLinkedQueue<Character>> String_ConcurrentLinkedQueue = Function
			.compose(Java.<Character> List_ConcurrentLinkedQueue(),
					Conversions.String_List);

	/**
	 * A function that converts strings to copy on write array lists.
	 */
	public static final F<String, CopyOnWriteArrayList<Character>> String_CopyOnWriteArrayList = Function
			.compose(Java.<Character> List_CopyOnWriteArrayList(),
					Conversions.String_List);

	/**
	 * A function that converts strings to copy on write array sets.
	 */
	public static final F<String, CopyOnWriteArraySet<Character>> String_CopyOnWriteArraySet = Function
			.compose(Java.<Character> List_CopyOnWriteArraySet(),
					Conversions.String_List);

	/**
	 * A function that converts strings to linked blocking queues.
	 */
	public static final F<String, LinkedBlockingQueue<Character>> String_LinkedBlockingQueue = Function
			.compose(Java.<Character> List_LinkedBlockingQueue(),
					Conversions.String_List);

	/**
	 * A function that converts strings to priority blocking queues.
	 */
	public static final F<String, PriorityBlockingQueue<Character>> String_PriorityBlockingQueue = Function
			.compose(Java.<Character> List_PriorityBlockingQueue(),
					Conversions.String_List);
	 ...
	 */
	public static F<String, SynchronousQueue<Character>> String_SynchronousQueue(
			final boolean fair) {
		return Function.compose(Java.<Character> List_SynchronousQueue(fair),
				Conversions.String_List);
	}
	 ...
	 */
	public static final F<StringBuffer, ArrayList<Character>> StringBuffer_ArrayList = Function
			.compose(Java.<Character> List_ArrayList(),
					Conversions.StringBuffer_List);

	/**
	 * A function that converts string buffers to hash sets.
	 */
	public static final F<StringBuffer, HashSet<Character>> StringBuffer_HashSet = Function
			.compose(Java.<Character> List_HashSet(),
					Conversions.StringBuffer_List);

	/**
	 * A function that converts string buffers to linked hash sets.
	 */
	public static final F<StringBuffer, LinkedHashSet<Character>> StringBuffer_LinkedHashSet = Function
			.compose(Java.<Character> List_LinkedHashSet(),
					Conversions.StringBuffer_List);
	 ...
	 */
	public static final F<StringBuffer, LinkedList<Character>> StringBuffer_LinkedList = Function
			.compose(Java.<Character> List_LinkedList(),
					Conversions.StringBuffer_List);
	 ...
	 */
	public static final F<StringBuffer, PriorityQueue<Character>> StringBuffer_PriorityQueue = Function
			.compose(Java.<Character> List_PriorityQueue(),
					Conversions.StringBuffer_List);
	 ...
	 */
	public static final F<StringBuffer, Stack<Character>> StringBuffer_Stack = Function
			.compose(Java.<Character> List_Stack(),
					Conversions.StringBuffer_List);

	/**
	 * A function that converts string buffers to tree sets.
	 */
	public static final F<StringBuffer, TreeSet<Character>> StringBuffer_TreeSet = Function
			.compose(Java.<Character> List_TreeSet(),
					Conversions.StringBuffer_List);

	/**
	 * A function that converts string buffers to vectors.
	 */
	public static final F<StringBuffer, Vector<Character>> StringBuffer_Vector = Function
			.compose(Java.<Character> List_Vector(),
					Conversions.StringBuffer_List);
	 ...
	 */
	public static F<StringBuffer, ArrayBlockingQueue<Character>> StringBuffer_ArrayBlockingQueue(
			final boolean fair) {
		return Function.compose(Java.<Character> List_ArrayBlockingQueue(fair),
				Conversions.StringBuffer_List);
	}
	 ...
	 */
	public static final F<StringBuffer, ConcurrentLinkedQueue<Character>> StringBuffer_ConcurrentLinkedQueue = Function
			.compose(Java.<Character> List_ConcurrentLinkedQueue(),
					Conversions.StringBuffer_List);
	 ...
	 */
	public static final F<StringBuffer, CopyOnWriteArrayList<Character>> StringBuffer_CopyOnWriteArrayList = Function
			.compose(Java.<Character> List_CopyOnWriteArrayList(),
					Conversions.StringBuffer_List);
	 ...
	 */
	public static final F<StringBuffer, CopyOnWriteArraySet<Character>> StringBuffer_CopyOnWriteArraySet = Function
			.compose(Java.<Character> List_CopyOnWriteArraySet(),
					Conversions.StringBuffer_List);
	 ...
	 */
	public static final F<StringBuffer, LinkedBlockingQueue<Character>> StringBuffer_LinkedBlockingQueue = Function
			.compose(Java.<Character> List_LinkedBlockingQueue(),
					Conversions.StringBuffer_List);
	 ...
	 */
	public static final F<StringBuffer, PriorityBlockingQueue<Character>> StringBuffer_PriorityBlockingQueue = Function
			.compose(Java.<Character> List_PriorityBlockingQueue(),
					Conversions.StringBuffer_List);
	 ...
	 */
	public static F<StringBuffer, SynchronousQueue<Character>> StringBuffer_SynchronousQueue(
			final boolean fair) {
		return Function.compose(Java.<Character> List_SynchronousQueue(fair),
				Conversions.StringBuffer_List);
	}
	 ...
	 */
	public static final F<StringBuilder, ArrayList<Character>> StringBuilder_ArrayList = Function
			.compose(Java.<Character> List_ArrayList(),
	 ...
	 */
	public static final F<StringBuilder, HashSet<Character>> StringBuilder_HashSet = Function
			.compose(Java.<Character> List_HashSet(),
					Conversions.StringBuilder_List);
	 ...
	 */
	public static final F<StringBuilder, LinkedHashSet<Character>> StringBuilder_LinkedHashSet = Function
			.compose(Java.<Character> List_LinkedHashSet(),
					Conversions.StringBuilder_List);
	 ...
	 */
	public static final F<StringBuilder, LinkedList<Character>> StringBuilder_LinkedList = Function
			.compose(Java.<Character> List_LinkedList(),
					Conversions.StringBuilder_List);
	 ...
	 */
	public static final F<StringBuilder, PriorityQueue<Character>> StringBuilder_PriorityQueue = Function
			.compose(Java.<Character> List_PriorityQueue(),
					Conversions.StringBuilder_List);
	 ...
	 */
	public static final F<StringBuilder, Stack<Character>> StringBuilder_Stack = Function
			.compose(Java.<Character> List_Stack(),
					Conversions.StringBuilder_List);
	 ...
	 */
	public static final F<StringBuilder, TreeSet<Character>> StringBuilder_TreeSet = Function
			.compose(Java.<Character> List_TreeSet(),
					Conversions.StringBuilder_List);
	 ...
	 */
	public static final F<StringBuilder, Vector<Character>> StringBuilder_Vector = Function
			.compose(Java.<Character> List_Vector(),
					Conversions.StringBuilder_List);
	 ...
	 *            The argument to pass to the constructor of the array blocking
	 *            queue.
	 * @return A function that converts string builders to array blocking
	 *         queues.
	 */
	public static F<StringBuilder, ArrayBlockingQueue<Character>> StringBuilder_ArrayBlockingQueue(
			final boolean fair) {
		return Function.compose(Java.<Character> List_ArrayBlockingQueue(fair),
				Conversions.StringBuilder_List);
	}
	 ...
	 */
	public static final F<StringBuilder, ConcurrentLinkedQueue<Character>> StringBuilder_ConcurrentLinkedQueue = Function
			.compose(Java.<Character> List_ConcurrentLinkedQueue(),
					Conversions.StringBuilder_List);
	 ...
	 */
	public static final F<StringBuilder, CopyOnWriteArrayList<Character>> StringBuilder_CopyOnWriteArrayList = Function
			.compose(Java.<Character> List_CopyOnWriteArrayList(),
					Conversions.StringBuilder_List);
	 ...
	 */
	public static final F<StringBuilder, CopyOnWriteArraySet<Character>> StringBuilder_CopyOnWriteArraySet = Function
			.compose(Java.<Character> List_CopyOnWriteArraySet(),
					Conversions.StringBuilder_List);
	 ...
	 */
	public static final F<StringBuilder, LinkedBlockingQueue<Character>> StringBuilder_LinkedBlockingQueue = Function
			.compose(Java.<Character> List_LinkedBlockingQueue(),
					Conversions.StringBuilder_List);
	 ...
	 */
	public static final F<StringBuilder, PriorityBlockingQueue<Character>> StringBuilder_PriorityBlockingQueue = Function
			.compose(Java.<Character> List_PriorityBlockingQueue(),
					Conversions.StringBuilder_List);
	 ...
	 */
	public static F<StringBuilder, SynchronousQueue<Character>> StringBuilder_SynchronousQueue(
			final boolean fair) {
		return Function.compose(Java.<Character> List_SynchronousQueue(fair),
				Conversions.StringBuilder_List);
	}
	 ...
	 */
	public static final F<BitSet, List<Boolean>> BitSet_List = s -> List
			.unfold(i -> i == s.length() ? Option.<P2<Boolean, Integer>> none()
