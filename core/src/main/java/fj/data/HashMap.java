...
public final class HashMap<K, V> implements Iterable<K> {
	...
	/**
	 * Returns an iterator for this map's keys. This method exists to permit the
	...
	/**
	 * Construct a hash map that uses {@link Object#equals} and
	 * {@link Object#hashCode}.
	 * 
	 * @return A new hash map that uses {@link Object#equals} and
	 *         {@link Object#hashCode}.
	 */
	...
	/**
	 * Compare two key values for equality using the underlying equality
	 * strategy.
	 * 
	 * @param k1
	 *            One key value to compare.
	 * @param k2
	 *            The other key value to compare.
	 * @return <code>true</code> if the two key values are equal,
	...
	/**
	 * Compute the hash of the given key value using the underlying hashing
	 * strategy.
	 * 
	 * @param k
	 ...
	 * @return <code>true</code> if this hash map contains the given key,
	 *         <code>false</code> otherwise.
	 */
	 ...
	 * 
	 * @return <code>true</code> if this hash map has no entries,
	 *         <code>false</code> otherwise.
	 */
	...
	/**
	 * Deletes the entry in the hash map that corresponds to the given key and
	 * returns any associated value.
	 * 
	 * @param k
	 *            The key to delete from this hash map.
	 * @return The value that was associated with the given key, if there was
	 *         one.
	 */
