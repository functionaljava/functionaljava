...
public final class HPre {
	...
	/**
	 * Type-level boolean conjunction. A value of this type represents evidence
	 * that AB -> C
	 * 
	 * @param <A>
	 *            A boolean
	...
	public static final class HAnd<A extends HBool, B extends HBool, C extends HBool> {
		...
		public static HAnd<HFalse, HFalse, HFalse> hAnd(final HFalse a,
				final HFalse b) {
			return new HAnd<HFalse, HFalse, HFalse>(hFalse());
		}

		public static HAnd<HTrue, HFalse, HFalse> hAnd(final HTrue a,
				final HFalse b) {
			return new HAnd<HTrue, HFalse, HFalse>(hFalse());
		}

		public static HAnd<HFalse, HTrue, HFalse> hAnd(final HFalse a,
				final HTrue b) {
			return new HAnd<HFalse, HTrue, HFalse>(hFalse());
		}

		public static HAnd<HTrue, HTrue, HTrue> hAnd(final HTrue a,
				final HTrue b) {
	...
	/**
	 * Type-level boolean disjunction. A value of this type represents evidence
	 * that A+B -> C
	 * 
	 * @param <A>
	 *            A boolean
	...
	public static final class HOr<A extends HBool, B extends HBool, C extends HBool> {
		...
		public static HOr<HFalse, HFalse, HFalse> hOr(final HFalse a,
				final HFalse b) {
			return new HOr<HFalse, HFalse, HFalse>(hFalse());
		}

		public static HOr<HTrue, HFalse, HTrue> hOr(final HTrue a,
				final HFalse b) {
			return new HOr<HTrue, HFalse, HTrue>(hTrue());
		}

		public static HOr<HFalse, HTrue, HTrue> hOr(final HFalse a,
				final HTrue b) {
	...
	/**
	 * A type-level conditional. The type of the last parameter is implied by
	 * the first three.
	 * 
	 * @param <T>
	 *            A boolean
	 * @param <X>
	 *            The type of Z if T is true.
	 * @param <Y>
	 *            The type of Z if T is false.
	 * @param <Z>
	...
	public static final class HCond<T, X, Y, Z> {
		...
		public static <X, Y> HCond<HFalse, X, Y, Y> hCond(final HFalse t,
				final X x, final Y y) {
			return new HCond<HFalse, X, Y, Y>(y);
		}

		public static <X, Y> HCond<HTrue, X, Y, X> hCond(final HTrue t,
				final X x, final Y y) {
	...
	/**
	 * Type-level equality. Represents evidence for X and Y being equal, or
	...
	public static final class HEq<X, Y, B extends HBool> {
		 ...
		 */
		public static <N extends HNat<N>> HEq<HZero, HSucc<N>, HFalse> eq(
				final HZero a, final HSucc<N> b) {
		 ...
		 * Zero is not equal to anything other than zero.
		 */
		public static <N extends HNat<N>> HEq<HSucc<N>, HZero, HFalse> eq(
				final HSucc<N> a, final HZero b) {
		 ...
		 */
		public static <N extends HNat<N>, NN extends HNat<NN>, B extends HBool, E extends HEq<N, NN, B>> HEq<HSucc<N>, HSucc<NN>, B> eq(
				final HSucc<N> a, final HSucc<NN> b, final E e) {
	...
	public static final class HAdd<A extends HNat<A>, B extends HNat<B>, C extends HNat<C>> {
		 ...
		 */
		public static <N extends HNat<N>> HAdd<HZero, HSucc<N>, HSucc<N>> add(
				final HZero a, final HSucc<N> b) {
		 ...
		 * The sum of zero and any other number is that number.
		 */
		public static <N extends HNat<N>> HAdd<HSucc<N>, HZero, HSucc<N>> add(
				final HSucc<N> a, final HZero b) {
			return new HAdd<HSucc<N>, HZero, HSucc<N>>(a);
		}

		/**
		 * The sum of numbers a and b is one greater than the sum of b and the
		 * predecessor of a.
		 */
		public static <N extends HNat<N>, M extends HNat<M>, R extends HNat<R>, H extends HAdd<N, HSucc<M>, R>> HAdd<HSucc<N>, HSucc<M>, HSucc<R>> add(
				final HSucc<N> a, final HSucc<M> b, final H h) {
