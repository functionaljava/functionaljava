...
/**
 * Provides a pointed stream, which is a non-empty zipper-like stream structure
 * that tracks an index (focus) position in a stream. Focus can be moved forward
 * and backwards through the stream, elements can be inserted before or after
 * the focused position, and the focused item can be deleted.
 * <p/>
...
public final class Zipper<A> implements Iterable<Zipper<A>> {
	...
	/**
	 * Creates a new Zipper with the given streams before and after the focus,
	 * and the given focused item.
	 * 
	 * @param left
	 ...
	 * @param right
	 *            The stream of elements after the focus.
	 * @return a new Zipper with the given streams before and after the focus,
	 *         and the given focused item.
	 */
	public static <A> Zipper<A> zipper(final Stream<A> left, final A focus,
			final Stream<A> right) {
	 ...
	 * 
	 * @param p
	 *            A triple of the elements before the focus, the focus element,
	 *            and the elements after the focus, respectively.
	 ...
	 * 
	 * @return A function that yields a new zipper given streams on the left and
	 *         right and a focus element.
	 */
	...
	/**
	 * A first-class function that yields the product-3 representation of a
	 * given Zipper.
	 * 
	 * @return A first-class function that yields the product-3 representation
	 *         of a given Zipper.
	 */
	 ...
	 * 
	 * @param e
	 *            An Equal instance for the element type.
	 ...
	 * 
	 * @param s
	 *            A Show instance for the element type.
	...
	/**
	 * Maps the given function across the elements of this zipper (covariant
	 * functor pattern).
	 * 
	 * @param f
	...
	public <B> B foldRight(final F<A, F<B, B>> f, final B z) {
		return left.foldLeft(
				flip(f),
				right.cons(focus).foldRight(
						compose(Function.<P1<B>, B, B> andThen()
								.f(P1.<B> __1()), f), z));
	}
	...
	/**
	 * Possibly create a zipper if the provided stream has at least one element,
	 * otherwise None. The provided stream's head will be the focus of the
	 * zipper, and the rest of the stream will follow on the right side.
	 * 
	 * @param a
	 *            The stream from which to create a zipper.
	 * @return a new zipper if the provided stream has at least one element,
	 *         otherwise None.
	 */
	...
	/**
	 * Possibly create a zipper if the provided stream has at least one element,
	 * otherwise None. The provided stream's last element will be the focus of
	 * the zipper, following the rest of the stream in order, to the left.
	 * 
	 * @param a
	 *            The stream from which to create a zipper.
	 * @return a new zipper if the provided stream has at least one element,
	 ...
	 * 
	 * @return An optional zipper with the focus moved one element to the right,
	 *         if there are elements to the right of focus, otherwise None.
	 */
	...
	/**
	 * Attempts to move the focus to the next element, or throws an error if
	 * there are no more elements.
	 * 
	 * @return A zipper with the focus moved one element to the right, if there
	 *         are elements to the right of focus, otherwise throws an error.
	 */
	 ...
	 * 
	 * @return An optional zipper with the focus moved one element to the left,
	 *         if there are elements to the left of focus, otherwise None.
	 */
	...
	/**
	 * Attempts to move the focus to the previous element, or throws an error if
	 * there are no more elements.
	 * 
	 * @return A zipper with the focus moved one element to the left, if there
	 *         are elements to the left of focus, otherwise throws an error.
	 */
	 ...
	 * 
	 * @return A function that moves the given zipper's focus to the next
	 *         element.
	 */
	 ...
	 * 
	 * @return A function that moves the given zipper's focus to the previous
	 *         element.
	 */
	...
	/**
	 * Inserts an element to the left of the focus, then moves the focus to the
	 * new element.
	 * 
	 * @param a
	 *            A new element to insert into this zipper.
	 * @return A new zipper with the given element in focus, and the current
	 *         focus element on its right.
	 */
	...
	/**
	 * Inserts an element to the right of the focus, then moves the focus to the
	 * new element.
	 * 
	 * @param a
	 *            A new element to insert into this zipper.
	 * @return A new zipper with the given element in focus, and the current
	 *         focus element on its left.
	 */
	...
	/**
	 * Possibly deletes the element at the focus, then moves the element on the
	 * left into focus. If no element is on the left, focus on the element to
	 * the right. Returns None if the focus element is the only element in this
	 * zipper.
	 * 
	 * @return A new zipper with this zipper's focus element removed, or None if
	 *         deleting the focus element would cause the zipper to be empty.
	 */
	public Option<Zipper<A>> deleteLeft() {
		return left.isEmpty() && right.isEmpty() ? Option.<Zipper<A>> none()
	...
	/**
	 * Possibly deletes the element at the focus, then moves the element on the
	 * right into focus. If no element is on the right, focus on the element to
	 * the left. Returns None if the focus element is the only element in this
	 * zipper.
	 * 
	 * @return A new zipper with this zipper's focus element removed, or None if
	 *         deleting the focus element would cause the zipper to be empty.
	...
	public int length() {
		return foldRight(
				Function.<A, F<Integer, Integer>> constant(Integers.add.f(1)),
				0);
	}
	...
	/**
	 * Creates a zipper of variations of this zipper, in which each element is
	 * focused, with this zipper as the focus of the zipper of zippers (comonad
	 * pattern).
	 * 
	 * @return a zipper of variations of the provided zipper, in which each
	 *         element is focused, with this zipper as the focus of the zipper
	 *         of zippers.
	 */
	public Zipper<Zipper<A>> positions() {
		final Stream<Zipper<A>> left = Stream.unfold(
				p -> p.previous().map(join(P.<Zipper<A>, Zipper<A>> p2())),
				this);
	...
	/**
	 * Maps over variations of this zipper, such that the given function is
	 * applied to each variation (comonad pattern).
	 * 
	 * @param f
	 *            The comonadic function to apply for each variation of this
	 *            zipper.
	 * @return A new zipper, with the given function applied for each variation
	 *         of this zipper.
	 */
	...
	/**
	 * Zips the elements of this zipper with a boolean that indicates whether
	 * that element has focus. All of the booleans will be false, except the
	 * focused element.
	 * 
	 * @return A new zipper of pairs, with each element of this zipper paired
	 *         with a boolean that is true if that element has focus, and false
	 *         otherwise.
	 */
	public Zipper<P2<A, Boolean>> zipWithFocus() {
		return zipper(left.zip(repeat(false)), P.p(focus, true),
				right.zip(repeat(false)));
	}
	 ...
	 * 
	 * @param n
	 *            The index to which to move the focus.
	 * @return A new zipper with the focus moved to the specified index, or none
	 ...
	 * 
	 * @return A function that moves the focus of the given zipper to the given
	 *         index.
	 */
	 ...
	 * @return A new zipper with the nearest matching element focused if it is
	 *         present in this zipper.
	 */
	public Option<Zipper<A>> find(final F<A, Boolean> p) {
		if (p.f(focus()))
			...
			return ps.lefts().interleave(ps.rights())
					.find(zipper -> p.f(zipper.focus()));
		}
	}
	...
	/**
	 * Move the focus to the next element. If the last element is focused, loop
	 * to the first element.
	 * 
	 * @return A new zipper with the next element focused, unless the last
	 *         element is currently focused, in which case the first element
	 *         becomes focused.
	 */
	public Zipper<A> cycleNext() {
		if (left.isEmpty() && right.isEmpty())
			...
			return zipper(Stream.<A> nil(), xs.head(),
					xs.tail()._1().snoc(P.p(focus)));
		} else
			return tryNext();
	}

	/**
	 * Move the focus to the previous element. If the first element is focused,
	 * loop to the last element.
	 * 
	 * @return A new zipper with the previous element focused, unless the first
	 *         element is currently focused, in which case the last element
	 *         becomes focused.
	 */
	public Zipper<A> cyclePrevious() {
		if (left.isEmpty() && right.isEmpty())
			...
			return zipper(xs.tail()._1().snoc(P.p(focus)), xs.head(),
					Stream.<A> nil());
		} else
			return tryPrevious();
	}
	...
	/**
	 * Possibly deletes the element at the focus, then move the element on the
	 * left into focus. If no element is on the left, focus on the last element.
	 * If the deletion will cause the list to be empty, return None.
	 * 
	 * @return A new zipper with the focused element removed, and focus on the
	 *         previous element to the left, or the last element if there is no
	 *         element to the left.
	 */
	...
	/**
	 * Possibly deletes the element at the focus, then move the element on the
	 * right into focus. If no element is on the right, focus on the first
	 * element. If the deletion will cause the list to be empty, return None.
	 * 
	 * @return A new zipper with the focused element removed, and focus on the
	 *         next element to the right, or the first element if there is no
	...
	/**
	 * Zips this Zipper with another, applying the given function lock-step over
	 * both zippers in both directions. The structure of the resulting Zipper is
	 * the structural intersection of the two Zippers.
	 * 
	 * @param bs
	 *            A Zipper to zip this one with.
	 * @param f
	 *            A function with which to zip together the two Zippers.
	 * @return The result of applying the given function over this Zipper and
	 *         the given Zipper, location-wise.
	 */
	...
	/**
	 * Returns an iterator of all the positions of this Zipper, starting from
	 * the leftmost position.
	 * 
	 * @return An iterator of all the positions of this Zipper, starting from
	 *         the leftmost position.
	 */
