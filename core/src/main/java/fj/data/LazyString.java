...
public final class LazyString implements CharSequence {
	...
	/**
	 * Gets the specified subsequence of this lazy string. This operation does
	 * not fail for indexes that are out of bounds. If the start index is past
	 * the end of this lazy string, then the resulting character sequence will
	 * be empty. If the end index is past the end of this lazy string, then the
	 * resulting character sequence will be truncated.
	 * 
	 * @param start
	 *            The character index of this lazy string at which to start the
	 *            subsequence.
	 * @param end
	 *            The character index of this lazy string at which to end the
	 *            subsequence.
	 * @return A character sequence containing the specified character
	 *         subsequence.
	 */
	 ...
	 * @return A new lazy string that is the concatenation of this string and
	 *         the given string.
	 */
	 ...
	 * @return A new lazy string that is the concatenation of this lazy string
	 ...
	 * @return True if the given string is a substring of this string, otherwise
	 *         False.
	 */
	 ...
	 * @return True if the given string is a suffix of this lazy string,
	 *         otherwise False.
	 */
	 ...
	 * @return True if the given string is a prefix of this lazy string,
	 *         otherwise False.
	 */
	public boolean startsWith(final LazyString cs) {
		return cs.isEmpty() || !isEmpty() && charEqual.eq(head(), cs.head())
				&& tail().startsWith(cs.tail());
	}

	/**
	 * First-class prefix check.
	 * 
	 * @return A function that yields true if the first argument is a prefix of
	 *         the second.
	 */
	 ...
	 * 
	 * @return The first character of this string, or error if the string is
	 *         empty.
	 */
	public char head() {
		return s.head();
	 ...
	 * 
	 * @return All but the first character of this string, or error if the
	 *         string is empty.
	 */
	...
	/**
	 * Returns the first index of the given character in this lazy string, if
	 * present.
	 * 
	 * @param c
	 *            A character to find in this lazy string.
	 * @return The first index of the given character in this lazy string, or
	 *         None if the character is not present.
	 */
	...
	/**
	 * Returns the first index of the given substring in this lazy string, if
	 * present.
	 * 
	 * @param cs
	 *            A substring to find in this lazy string.
	 * @return The first index of the given substring in this lazy string, or
	 *         None if there is no such substring.
	 */
	 ...
	 * @return True if this string mathches the given regular expression,
	 *         otherwise False.
	 */
	 ...
	 * 
	 * @param p
	 *            A predicate that matches characters to be considered
	 *            delimiters.
	 * @return A stream of the substrings in this lazy string, when separated by
	 *         the given predicate.
	 */
	public Stream<LazyString> split(final F<Character, Boolean> p) {
		...
		return findIt.isEmpty() ? Stream.<LazyString> nil() : Stream.cons(
				fromStream(ws._1()), new P1<Stream<LazyString>>() {
	 ...
	 * @return A stream of substrings of this lazy string, when separated by the
	 *         given delimiter.
	 */
	 ...
	 * 
	 * @return A stream of the lines in this lazy string, when split by
	 *         newlines.
	 */
	 ...
	 * @return A new lazy string, consisting of the given strings separated by
	 *         newlines.
	 */
	 ...
	 * @return A new lazy string, consisting of the given strings with spaces in
	 *         between.
	 */
	 ...
	 */
	public static final F<LazyString, Stream<Character>> toStream = string -> string
			.toStream();

	/**
	 * First-class conversion from lazy strings to String.
	 */
	public static final F<LazyString, String> toString = string -> string
			.toString();

	/**
	 * First-class conversion from character streams to lazy strings.
	 */
	public static final F<Stream<Character>, LazyString> fromStream = LazyString::fromStream;
