...
/**
 * A memoised generator variant. Stores generators that have already been
...
public final class Variant {
	...
	private static final class LongGen {
		...
		public boolean equals(final Object o) {
			return o != null && o.getClass() == LongGen.class
					&& n == ((LongGen) o).n && gen == ((LongGen) o).gen;
		}
	...
	/**
	 * Produces a generator that is independent of the given generator using the
	 * given value.
	 * 
	 * @param n
	 ...
	 * @return A generator that is independent of the given generator using the
	 *         given value.
	 */
