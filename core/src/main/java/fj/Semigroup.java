 ...
 * <ul>
 * <li><em>Associativity</em>; forall x. forall y. forall z. sum(sum(x, y), z)
 * == sum(x, sum(y, z))</li>
 * </ul>
 * 
...
public final class Semigroup<A> {
	 ...
	 */
	public static final Semigroup<BigInteger> bigintAdditionSemigroup = semigroup((
			i1, i2) -> i1.add(i2));

	/**
	 * A semigroup that multiplies big integers.
	 */
	public static final Semigroup<BigInteger> bigintMultiplicationSemigroup = semigroup((
	 ...
	 */
	public static final Semigroup<BigDecimal> bigdecimalAdditionSemigroup = semigroup((
			i1, i2) -> i1.add(i2));

	/**
	 * A semigroup that multiplies big decimals.
	 */
	public static final Semigroup<BigDecimal> bigdecimalMultiplicationSemigroup = semigroup((
			i1, i2) -> i1.multiply(i2));
	 ...
	 */
	public static final Semigroup<Natural> naturalMultiplicationSemigroup = semigroup((
			n1, n2) -> n1.multiply(n2));

	/**
	 * A semigroup that adds natural numbers.
	 */
	public static final Semigroup<Natural> naturalAdditionSemigroup = semigroup((
			n1, n2) -> n1.add(n2));
	 ...
	 */
	public static final Semigroup<Long> longAdditionSemigroup = semigroup((x, y) -> x
			+ y);

	/**
	 * A semigroup that multiplies longs.
	 */
	public static final Semigroup<Long> longMultiplicationSemigroup = semigroup((
			x, y) -> x * y);
	 ...
	 */
	public static final Semigroup<Boolean> disjunctionSemigroup = semigroup((
			b1, b2) -> b1 || b2);

	/**
	 * A semigroup that XORs booleans.
	 */
	public static final Semigroup<Boolean> exclusiveDisjunctionSemiGroup = semigroup((
			p, q) -> p && !q || !p && q);
	 ...
	 */
	public static final Semigroup<StringBuilder> stringBuilderSemigroup = semigroup((
	 ...
	 */
	public static <A, B> Semigroup<F<A, B>> functionSemigroup(
	 ...
	 * 
	 * @return A semigroup for optional values that take the last available
	 *         value.
	 */
	...
	public static <A> Semigroup<P1<A>> p1Semigroup(final Semigroup<A> sa) {
		return semigroup((a1, a2) -> () -> sa.sum(a1._1(), a2._1()));
	}
